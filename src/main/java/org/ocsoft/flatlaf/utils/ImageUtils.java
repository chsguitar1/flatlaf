...
public final class ImageUtils {
    ...
    public static boolean isImageContains(final BufferedImage image,
    ...
    public static BufferedImage createCompatibleImage(final int width,
            final int height) {
        return FlatLafSystemUtils.getGraphicsConfiguration()
    ...
    public static BufferedImage createCompatibleImage(
            final BufferedImage image, final int transparency) {
        return createCompatibleImage(image.getWidth(), image.getHeight(),
                transparency);
    }
    ...
    public static BufferedImage toCompatibleImage(final BufferedImage image) {
        ...
        final BufferedImage compatibleImage = FlatLafSystemUtils
    ...
    public static boolean isCompatibleImage(final BufferedImage image) {
        return image.getColorModel().equals(
                FlatLafSystemUtils.getGraphicsConfiguration().getColorModel());
    }
    ...
    public static BufferedImage cutImage(final Shape shape, final Image image) {
        ...
        final BufferedImage cutImage = createCompatibleImage(w, h,
    ...
    public static List<Image> toImagesList(
            final List<? extends ImageIcon> imageIcons) {
    ...
    public static ImageIcon combineIcons(final int spacing,
    ...
    public static BufferedImage combineIcons(final int spacing,
            final Image... images) {
        // No images given
        ...
        for (final Image image : images) {
            if (image != null) {
                ...
                maxSize.height = Math
                        .max(maxSize.height, image.getHeight(null));
            }
        }
        ...
        final BufferedImage bi = createCompatibleImage(maxSize.width,
                maxSize.height, Transparency.TRANSLUCENT);
    ...
    public static ImageIcon mergeIcons(final String key,
            final List<ImageIcon> icons) {
    ...
    public static BufferedImage mergeImages(final String key,
            final Image... images) {
    ...
    public static ImageIcon addBackground(final ImageIcon imageIcon,
            final Color background) {
        return new ImageIcon(addBackground(getBufferedImage(imageIcon),
                background));
    }
    
    public static BufferedImage addBackground(final BufferedImage image,
            final Color background) {
    ...
    public static ImageIcon resizeCanvas(final ImageIcon imageIcon,
            final int width, final int height) {
        return new ImageIcon(resizeCanvas(getBufferedImage(imageIcon), width,
                height));
    }
    
    public static BufferedImage resizeCanvas(final BufferedImage image,
            final int width, final int height) {
    ...
    public static BufferedImage rotateImage90CW(final BufferedImage image) {
        final BufferedImage bufferedImage = createCompatibleImage(
                image.getHeight(), image.getWidth(), Transparency.TRANSLUCENT);
    ...
    public static ImageIcon createColorIcon(final Color color, final int width,
            final int height) {
    ...
    public static BufferedImage createColorImage(final Color color,
            final int width, final int height) {
        final BufferedImage image = createCompatibleImage(width, height,
                Transparency.TRANSLUCENT);
        final Graphics2D g2d = image.createGraphics();
        GraphicsUtils.setupAntialias(g2d);
        g2d.setPaint(Color.GRAY);
        g2d.drawRoundRect(0, 0, width - 1, height - 1,
                FlatLafStyleConstants.largeRound,
                FlatLafStyleConstants.bigRound);
        g2d.setPaint(Color.WHITE);
        g2d.drawRoundRect(1, 1, width - 3, height - 3,
                FlatLafStyleConstants.bigRound, FlatLafStyleConstants.bigRound);
        g2d.setPaint(color);
    ...
    public static final ImageIcon coloredChooserIcon = new ImageIcon(
            ImageUtils.class.getResource("icons/color/color.png"));
    public static final ImageIcon transarentChooserIcon = new ImageIcon(
            ImageUtils.class.getResource("icons/color/transparent.png"));
    ...
    public static BufferedImage createColorChooserImage(final Color color) {
        final BufferedImage image = createCompatibleImage(16, 16,
                Transparency.TRANSLUCENT);
        final Graphics2D g2d = image.createGraphics();
    ...
    public static boolean isImageLoadable(final String name) {
        return FlatLafConstants.IMAGE_FORMATS.contains(FileUtils
                .getFileExtPart(name, false).toLowerCase());
    }
    ...
    public static ImageIcon createThumbnailIcon(final String src, final int size) {
        ...
        if (icon != null) {
            ...
            // Saving image size
            if (imageIcon != null) {
                imageIcon.setDescription(icon.getIconWidth() + "x"
                        + icon.getIconHeight());
            }
    ...
    public static ImageIcon createPreviewIcon(final ImageIcon image,
            final int size) {
    ...
    public static ImageIcon createPreviewIcon(final BufferedImage image,
            final int size) {
    ...
    public static BufferedImage createPreviewImage(final BufferedImage image,
            final Dimension fitTo) {
    ...
    public static BufferedImage createPreviewImage(final BufferedImage image,
        ...
        if (image.getWidth() <= length && image.getHeight() <= length) {
            ...
            width = length;
            height = Math.round((float) length * image.getHeight()
                    / image.getWidth());
        } else if (image.getWidth() < image.getHeight()) {
            height = length;
            width = Math.round((float) length * image.getWidth()
                    / image.getHeight());
        } else {
            width = height = length;
        }
        ...
        if (width >= 3 && height >= 3) {
            return new ResampleOp(width, height).filter(image,
                    createCompatibleImage(image));
        } else {
            final int w = Math.max(1, width);
            final int h = Math.max(1, height);
            
            final BufferedImage rescaledImage = createCompatibleImage(w, h,
                    Transparency.TRANSLUCENT);
    ...
    public static void clearImageCache(final String src) {
        if (iconsCache.size() > 0 && iconsCache.containsKey(src)) {
            if (iconsCache.get(src) != null
                    && iconsCache.get(src).getImage() != null) {
    ...
    public static BufferedImage getBufferedImage(final Image image) {
        ...
        // }
            ...
            final BufferedImage bi = createCompatibleImage(
    ...
    public static BufferedImage createBufferedImage(final Icon icon) {
        final BufferedImage bi = createCompatibleImage(icon.getIconWidth(),
    ...
    public static ImageIcon getSizedImagePreview(final String src,
            final int length, final boolean drawBorder) {
        if (sizedPreviewCache.containsKey(length + IMAGE_CACHE_SEPARATOR + src)) {
            ...
            final ImageIcon sized = createSizedImagePreview(icon, length,
                    drawBorder);
    ...
    public static ImageIcon getSizedImagePreview(final String id,
            final ImageIcon icon, final int length, final boolean drawBorder) {
    ...
    public static ImageIcon createSizedImagePreview(final ImageIcon icon,
            int length, final boolean drawBorder) {
        ...
        final BufferedImage bi = createCompatibleImage(length, length,
                Transparency.TRANSLUCENT);
        final Graphics2D g2d = bi.createGraphics();
        if (icon != null) {
            g2d.drawImage(icon.getImage(),
                    length / 2 - icon.getIconWidth() / 2,
    ...
    public static ImageIcon getDisabledCopy(final String key,
            final ImageIcon imageIcon) {
    ...
    public static BufferedImage createDisabledCopy(final Image img) {
        ...
        GraphicsUtils.setupAlphaComposite(g2d,
                FlatLafStyleConstants.disabledIconsTransparency);
    ...
    public static ImageIcon getTransparentCopy(final String id,
            final ImageIcon imageIcon, final float trasparency) {
        if (trasparentCache.containsKey(id)) {
            return trasparentCache.get(id);
        } else {
            trasparentCache.put(id,
                    createTransparentCopy(imageIcon, trasparency));
            return trasparentCache.get(id);
        }
    }
    
    public static ImageIcon createTransparentCopy(final ImageIcon imageIcon,
            final float trasparency) {
        final BufferedImage bi = createCompatibleImage(
    ...
    public static BufferedImage createPrettyImage(final Image image,
            final int shadeWidth, final int round) {
        return createPrettyImage(getBufferedImage(image), shadeWidth, round);
    }
    
    public static BufferedImage createPrettyImage(
            final BufferedImage bufferedImage, final int shadeWidth,
            final int round) {
        final int width = bufferedImage.getWidth();
        final int height = bufferedImage.getHeight();
        
        final BufferedImage bi = createCompatibleImage(width + shadeWidth * 2
                + 1, height + shadeWidth * 2 + 1, Transparency.TRANSLUCENT);
        final Graphics2D g2d = bi.createGraphics();
        GraphicsUtils.setupAntialias(g2d);
        GraphicsUtils.setupImageQuality(g2d);
        
        final RoundRectangle2D.Double border = new RoundRectangle2D.Double(
                shadeWidth, shadeWidth, width, height, round, round);
        ...
        GraphicsUtils.drawShade(g2d, border, FlatLafStyleConstants.shadeColor,
                shadeWidth);
        
        g2d.setPaint(new LinearGradientPaint(0, shadeWidth, 0, height
                - shadeWidth, new float[] { 0f, 0.5f, 1f }, new Color[] {
                new Color(125, 125, 125, 48), new Color(125, 125, 125, 0),
    ...
    public static BufferedImage createImageShade(final int w, final int h,
            final Shape shape, final int shadeWidth, final float shadeOpacity) {
        return createImageShade(w, h, shape, shadeWidth, shadeOpacity,
    ...
    public static BufferedImage createImageShade(final int w, final int h,
        ...
        final BufferedImage bi = createCompatibleImage(width, width,
                Transparency.TRANSLUCENT);
    ...
    public static BufferedImage createSimpleUpArrowImage(final int shadeWidth) {
        return createImageShade(10, 10, createUpArrowFill(), shadeWidth, 1f,
                Color.WHITE);
    }
    ...
    public static BufferedImage createUpArrowImage(final int shadeWidth) {
        return createArrowImage(createUpArrowFill(), createUpArrowBorder(),
                shadeWidth);
    }
    ...
    public static BufferedImage createSimpleLeftArrowImage(final int shadeWidth) {
        return createImageShade(10, 10, createLeftArrowFill(), shadeWidth, 1f,
                Color.WHITE);
    }
    ...
    public static BufferedImage createLeftArrowImage(final int shadeWidth) {
        return createArrowImage(createLeftArrowFill(), createLeftArrowBorder(),
                shadeWidth);
    }
    ...
    public static BufferedImage createSimpleDownArrowImage(final int shadeWidth) {
        return createImageShade(10, 10, createDownArrowFill(), shadeWidth, 1f,
                Color.WHITE);
    }
    ...
    public static BufferedImage createDownArrowImage(final int shadeWidth) {
        return createArrowImage(createDownArrowFill(), createDownArrowBorder(),
                shadeWidth);
    }
    ...
    public static BufferedImage createSimpleRightArrowImage(final int shadeWidth) {
        return createImageShade(10, 10, createRightArrowFill(), shadeWidth, 1f,
                Color.WHITE);
    }
    ...
    public static BufferedImage createRightArrowImage(final int shadeWidth) {
        return createArrowImage(createRightArrowFill(),
                createRightArrowBorder(), shadeWidth);
    }
    ...
    private static BufferedImage createArrowImage(final GeneralPath shape,
            final GeneralPath border, final int shadeWidth) {
        final BufferedImage image = createImageShade(10, 10, shape, shadeWidth,
                1f, Color.BLACK);
        final Graphics2D g2d = image.createGraphics();
        GraphicsUtils.setupAntialias(g2d);
        g2d.setPaint(Color.WHITE);
    ...
    public static BufferedImage decodeImage(final String imageString) {
        ...
        final byte[] bytes = EncryptionUtils.base64decode(imageString)
                .getBytes();
    ...
    public static String encodeImage(final BufferedImage image) {
        ...
        try {
            ...
            imageString = EncryptionUtils.base64encode(new String(bos
                    .toByteArray()));
            bos.close();
