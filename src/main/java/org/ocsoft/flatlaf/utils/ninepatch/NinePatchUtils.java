...
public final class NinePatchUtils {
     ...
     */
    public static NinePatchIcon getShadeIcon(final int shadeWidth,
            final int round, final float shadeOpacity) {
        final String key = OUTER_SHADE_PREFIX + ";" + shadeWidth + ";" + round
                + ";" + shadeOpacity;
        if (shadeIconCache.containsKey(key)) {
            return shadeIconCache.get(key);
        } else {
            final NinePatchIcon ninePatchIcon = createShadeIcon(shadeWidth,
                    round, shadeOpacity);
     ...
     */
    public static NinePatchIcon createShadeIcon(final int shadeWidth,
            final int round, final float shadeOpacity) {
        ...
        final BufferedImage bi = new BufferedImage(width, width,
                BufferedImage.TYPE_INT_ARGB);
        final Graphics2D ig = bi.createGraphics();
        GraphicsUtils.setupAntialias(ig);
        ig.setPaint(Color.BLACK);
        ig.fillRoundRect(shadeWidth, shadeWidth, width - shadeWidth * 2, width
                - shadeWidth * 2, round * 2, round * 2);
        ig.dispose();
        ...
        g2d.fillRoundRect(shadeWidth, shadeWidth, width - shadeWidth * 2, width
                - shadeWidth * 2, round * 2, round * 2);
        g2d.dispose();
        ...
        ninePatchIcon.addHorizontalStretch(shadeWidth + inner + 1, width
                - shadeWidth - inner - 1, false);
        ninePatchIcon.addHorizontalStretch(width - shadeWidth - inner, width,
                true);
        ninePatchIcon.addVerticalStretch(0, shadeWidth + inner, true);
        ninePatchIcon.addVerticalStretch(shadeWidth + inner + 1, width
                - shadeWidth - inner - 1, false);
        ninePatchIcon.addVerticalStretch(width - shadeWidth - inner, width,
                true);
     ...
     */
    public static NinePatchIcon getInnerShadeIcon(final int shadeWidth,
            final int round, final float shadeOpacity) {
        final String key = INNER_SHADE_PREFIX + ";" + shadeWidth + ";" + round
                + ";" + shadeOpacity;
        if (shadeIconCache.containsKey(key)) {
            return shadeIconCache.get(key);
        } else {
            final NinePatchIcon ninePatchIcon = createInnerShadeIcon(
                    shadeWidth, round, shadeOpacity);
            shadeIconCache.put(key, ninePatchIcon);
            return ninePatchIcon;
        }
    }
     ...
     */
    public static NinePatchIcon createInnerShadeIcon(final int shadeWidth,
            final int round, final float shadeOpacity) {
        // Calculating width for temprorary image
        ...
        area.exclusiveOr(new Area(new RoundRectangle2D.Double(shadeWidth,
                shadeWidth, width - shadeWidth * 2, width - shadeWidth * 2,
                round * 2, round * 2)));
        ig.setPaint(Color.BLACK);
        ig.fill(area);
        ig.dispose();
        ...
        final BufferedImage croppedShade = shade.getSubimage(shadeWidth,
                shadeWidth, width - shadeWidth * 2, width - shadeWidth * 2);
    ...
    public static List<NinePatchInterval> parseIntervals(
        ...
        final boolean hv = intervalType
                .equals(NinePatchIntervalType.horizontalStretch)
                || intervalType.equals(NinePatchIntervalType.verticalStretch);
        final int l = (intervalType
                .equals(NinePatchIntervalType.horizontalStretch)
                || intervalType.equals(NinePatchIntervalType.horizontalContent) ? image
                .getWidth() : image.getHeight()) - 1;
     ...
     */
    public static List<NinePatchInterval> parseStretchIntervals(
    ...
    /**
     * Returns rotated by 90 degrees clockwise NinePatchIcon. This method also
     * modifies patches information properly.
     *
     * @param icon
    ...
    public static NinePatchIcon rotateIcon90CW(final NinePatchIcon icon) {
        final BufferedImage rawImage = ImageUtils.rotateImage90CW(icon
                .getRawImage());
        final NinePatchIcon rotated = NinePatchIcon.create(rawImage);
        
        // Rotating stretch information
        rotated.setHorizontalStretch(CollectionUtils.copy(icon
                .getVerticalStretch()));
        rotated.setVerticalStretch(CollectionUtils.copy(icon
    ...
    /**
     * Returns rotated by 90 degrees counter-clockwise NinePatchIcon. This
     * method also modifies patches information properly.
     *
     * @param icon
     *            NinePatchIcon to rotate
    ...
    public static NinePatchIcon rotateIcon90CCW(final NinePatchIcon icon) {
        final BufferedImage rawImage = ImageUtils.rotateImage90CCW(icon
                .getRawImage());
        final NinePatchIcon rotated = NinePatchIcon.create(rawImage);
    ...
    /**
     * Returns rotated by 180 degrees NinePatchIcon. This method also modifies
     * patches information properly.
     *
     * @param icon
     *            NinePatchIcon to rotate
    ...
    public static NinePatchIcon rotateIcon180(final NinePatchIcon icon) {
        final BufferedImage rawImage = ImageUtils.rotateImage180(icon
                .getRawImage());
        final NinePatchIcon rotated = NinePatchIcon.create(rawImage);
     ...
     */
    public static NinePatchStatePainter loadNinePatchStatePainter(
            final Object source) {
     ...
     */
    public static NinePatchIconPainter loadNinePatchIconPainter(
            final Object source) {
