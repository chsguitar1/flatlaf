...
public final class SizeUtils {
     ...
     */
    public static <C extends Component> C setPreferredWidth(final C component,
     ...
     * @return modified component
     */
    public static <C extends Component> C setPreferredHeight(final C component,
     ...
     * @return modified component
     */
    public static <C extends Component> C setMinimumWidth(final C component,
     ...
     * @return modified component
     */
    public static <C extends Component> C setMinimumHeight(final C component,
     ...
     * @return modified component
     */
    public static <C extends Component> C setMaximumWidth(final C component,
     ...
     * @return modified component
     */
    public static <C extends Component> C setMaximumHeight(final C component,
     ...
     * @param component
     *            component to process
     * @param actualPreferredSize
     *            actual component preferred size
     * @param <C>
     *            component type
     * @return component preferred size
     */
    public static <C extends Component> Dimension getPreferredSize(
            final C component, final Dimension actualPreferredSize) {
        final Dimension ps = preferredSizeCache.get(component);
        ...
        if (ps != null && ps.height != -1) {
            ...
            if (min != null && min.height != -1) {
                preferredSize.height = Math.max(min.height,
     ...
     * @return modified component
     */
    public static <C extends Component> C setPreferredSize(final C component,
