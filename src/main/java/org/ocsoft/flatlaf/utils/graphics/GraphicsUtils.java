...
public final class GraphicsUtils {
    ...
    public static Object disableAntialias(final Graphics g) {
        return setupAntialias((Graphics2D) g,
    ...
    public static Map getSystemTextHints() {
        if (!systemTextHintsInitialized) {
            systemTextHints = (Map) Toolkit.getDefaultToolkit()
    ...
    public static Composite setupAlphaComposite(final Graphics2D g2d,
            final Float alpha) {
        return setupAlphaComposite(g2d, alpha, true);
    }
    
    public static Composite setupAlphaComposite(final Graphics2D g2d,
            final Float alpha, final boolean shouldSetup) {
        return setupAlphaComposite(g2d, g2d.getComposite(), alpha, shouldSetup);
    }
    
    public static Composite setupAlphaComposite(final Graphics2D g2d,
            final Composite composeWith, final Float alpha) {
    ...
    public static Composite setupAlphaComposite(final Graphics2D g2d,
        ...
        final AlphaComposite newComposite = AlphaComposite.getInstance(
                AlphaComposite.SRC_OVER, currentComposite * alpha);
        g2d.setComposite(newComposite);
        
        return comp;
    }
    
    public static void restoreComposite(final Graphics2D g2d,
            final Composite composite) {
        g2d.setComposite(composite);
    }
    
    public static void restoreComposite(final Graphics2D g2d,
            final Composite composite, final boolean shouldRestore) {
        if (shouldRestore) {
            g2d.setComposite(composite);
        }
    }
    ...
    public static Shape setupClip(final Graphics2D g2d, final int x,
    ...
    public static void restoreImageQuality(final Graphics2D g2d,
            final Object old) {
        g2d.setRenderingHint(RenderingHints.KEY_INTERPOLATION,
                old != null ? old : RenderingHints.VALUE_INTERPOLATION_BILINEAR);
    }
    ...
    public static void drawShade(final Graphics2D g2d, final Shape shape,
            final Color shadeColor, final int width) {
        drawShade(g2d, shape, FlatLafStyleConstants.shadeType, shadeColor,
                width);
    }
    
    public static void drawShade(final Graphics2D g2d, final Shape shape,
            final ShadeType shadeType, final Color shadeColor, final int width) {
        drawShade(g2d, shape, shadeType, shadeColor, width, null, true);
    }
    
    public static void drawShade(final Graphics2D g2d, final Shape shape,
            final Color shadeColor, final int width, final Shape clip) {
        drawShade(g2d, shape, FlatLafStyleConstants.shadeType, shadeColor,
                width, clip, true);
    }
    ...
    public static void drawShade(final Graphics2D g2d, final Shape shape,
            final Color shadeColor, final int width, final boolean round) {
        drawShade(g2d, shape, FlatLafStyleConstants.shadeType, shadeColor,
                width, null, round);
    }
    ...
    public static void drawShade(final Graphics2D g2d, final Shape shape,
            final ShadeType shadeType, final Color shadeColor, int width,
        ...
        // Applying clip
        final Shape oldClip = clip != null ? intersectClip(g2d, clip)
                : subtractClip(g2d, shape);
        ...
        if (shadeType.equals(ShadeType.simple)) {
            ...
            if (FlatLafStyleConstants.simpleShadeTransparency < 1f) {
                g2d.setComposite(AlphaComposite.getInstance(
                        ...
                        FlatLafStyleConstants.simpleShadeTransparency
                                * currentComposite));
            }
            g2d.setStroke(getStroke(width * 2, round ? BasicStroke.CAP_ROUND
            ...
            for (int i = width; i >= 2; i -= 2) {
                ...
                g2d.setComposite(AlphaComposite.getInstance(
                        AlphaComposite.SRC_OVER, opacity * currentComposite));
                g2d.setStroke(getStroke(i, round ? BasicStroke.CAP_ROUND
                        : BasicStroke.CAP_BUTT));
                g2d.draw(shape);
            }
        }
