...
public final class FlatLafSystemUtils {
     ...
     *         and above, false otherwise
     */
    public static boolean isJavaVersion(final double major, final int minor,
            final int update) {
    ...
    public static ImageIcon getOsIcon(int size, final boolean color) {
        ...
        return os != null ? new ImageIcon(
                FlatLafSystemUtils.class.getResource("icons/os/" + size + "/"
                        + os + mark + ".png")) : null;
    }
    ...
    public static Cursor getTransparentCursor() {
        if (transparentCursor == null) {
            final Dimension d = Toolkit.getDefaultToolkit().getBestCursorSize(
                    16, 16);
