...
public final class MapUtils {
     ...
     * @param <K>
     *            LinkedHashMap key type
     * @param <V>
     *            LinkedHashMap value type
     * @return copied LinkedHashMap
     */
    public static <K, V> LinkedHashMap<K, V> copyLinkedHashMap(
     ...
     * @return cloned Map
     */
    public static <K, V extends Cloneable> Map<K, V> cloneMap(
            final Map<K, V> map) {
        final Map<K, V> clone = new HashMap<K, V>(map.size());
        for (final Map.Entry<K, V> entry : map.entrySet()) {
            clone.put(entry.getKey(),
                    ReflectUtils.cloneSafely(entry.getValue()));
        }
        return clone;
    }
     ...
     */
    public static <K, V extends Cloneable> HashMap<K, V> cloneHashMap(
     ...
     */
    public static <K, V extends Cloneable> LinkedHashMap<K, V> cloneLinkedHashMap(
            final LinkedHashMap<K, V> map) {
     ...
     */
    public static <K, V extends Cloneable> DoubleMap<K, V> cloneLinkedHashMap(
            final DoubleMap<K, V> map) {
    ...
    /**
     * Returns newly created HashMap with the specified key and value pair
     * added.
     *
     * @param key
     *            key to add
    ...
    /**
     * Returns newly created HashMap with the specified key and value pairs
     * added.
     *
     * @param objects
     *            key-value pairs
        ...
        if (objects != null && objects.length > 0) {
            if (objects.length % 2 == 0) {
                ...
                throw new RuntimeException(
                        "Amount of key-value objects must be even");
            }
        } else {
    ...
    /**
     * Returns newly created LinkedHashMap with the specified key and value pair
     * added.
     *
     * @param key
     *            key to add
     ...
     */
    public static <K, V> LinkedHashMap<K, V> newLinkedHashMap(final K key,
            final V value) {
    ...
    /**
     * Returns newly created LinkedHashMap with the specified key and value
     * pairs added.
     *
     * @param objects
     *            key-value pairs
