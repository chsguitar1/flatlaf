...
public final class ReflectUtils {
    /**
     * Whether should allow safe methods to log errors or not. By default it is
     * disabled to hide some WebLaF exceptions which occur due to various method
     * checks. You can enable it in case you need a depper look into whats
     * happening here.
     */
    ...
    /**
     * Returns specified class field's type. This method will also look for the
     * field in super-classes if any exist.
     *
     * @param classType
     *            type of the class where field can be located
     * @param fieldName
     *            field name
     * @return specified class field's type
     */
    public static Class<?> getFieldTypeSafely(final Class classType,
        ...
        try {
            ...
            if (safeMethodsLoggingEnabled) {
                FlatLafLogger.warn(
                        "ReflectionUtils method failed: getFieldTypeSafely", e);
            }
            return null;
        }
    }
     ...
     */
    public static Class<?> getFieldType(final Class classType,
            final String fieldName) throws NoSuchFieldException {
        return getField(classType, fieldName).getType();
    }
    
    /**
     * Returns specified class field. This method will also look for the field
     * in super-classes if any exist.
     *
     * @param classType
     *            type of the class where field can be located
     * @param fieldName
     ...
     */
    public static Field getFieldSafely(final Class classType,
            final String fieldName) {
        try {
            ...
            if (safeMethodsLoggingEnabled) {
                FlatLafLogger.warn(
                        "ReflectionUtils method failed: getFieldSafely", e);
            }
            return null;
        }
    }
     ...
     * @throws NoSuchFieldException
     */
    public static Field getField(final Class classType, final String fieldName)
            throws NoSuchFieldException {
        ...
        if (field != null) {
            ...
            throw new NoSuchFieldException("Field \"" + fieldName
                    + "\" not found in class: " + classType.getCanonicalName());
        }
    }
     ...
     * @throws NoSuchFieldException
     */
    public static Field getFieldImpl(final Class classType,
            final String fieldName) throws NoSuchFieldException {
        Field field;
        try {
            ...
            field = superclass != null ? getFieldImpl(superclass, fieldName)
                    : null;
        }
        return field;
    }
    ...
    /**
     * Applies specified value to object field. This method allows to access and
     * modify even private object fields.
     *
     * @param object
     *            object instance
     * @param field
     ...
     */
    public static boolean setFieldValueSafely(final Object object,
        ...
        try {
            ...
            if (safeMethodsLoggingEnabled) {
                FlatLafLogger
                        .warn("ReflectionUtils method failed: setFieldValueSafely",
                                e);
            }
            return false;
        }
     ...
     * @throws NoSuchFieldException
     */
    public static void setFieldValue(final Object object, final String field,
    ...
    /**
     * Returns object field value. This method allows to access even private
     * object fields.
     *
     * @param object
     *            object instance
     ...
     */
    public static <T> T getFieldValueSafely(final Object object,
            final String field) {
        try {
            ...
            if (safeMethodsLoggingEnabled) {
                FlatLafLogger
                        .warn("ReflectionUtils method failed: getFieldValueSafely",
                                e);
            }
            return null;
        }
     ...
     */
    public static <T> T getStaticFieldValueSafely(final Class classType,
            final String fieldName) {
        try {
            ...
            if (safeMethodsLoggingEnabled) {
                FlatLafLogger
                        .warn("ReflectionUtils method failed: getStaticFieldValueSafely",
                                e);
            }
            return null;
        }
     ...
     * @throws IllegalAccessException
     */
    public static <T> T getStaticFieldValue(final Class classType,
            final String fieldName) throws NoSuchFieldException,
    ...
    public static Class getClassSafely(final String canonicalName) {
        try {
            ...
            if (safeMethodsLoggingEnabled) {
                FlatLafLogger.warn(
                        "ReflectionUtils method failed: getClassSafely", e);
            }
            return null;
        }
    }
     ...
     */
    public static <T> Class<T> getClass(final String canonicalName)
            throws ClassNotFoundException {
    ...
    public static JarStructure getJarStructure(final Class jarClass,
        ...
        return getJarStructure(jarClass, allowedExtensions, allowedPackgages,
                null);
    }
    ...
    public static JarStructure getJarStructure(final Class jarClass,
        ...
        try {
            final CodeSource src = jarClass.getProtectionDomain()
                    .getCodeSource();
            if (src != null) {
                // Creating structure
                ...
                if (scheme != null && scheme.equalsIgnoreCase("file")) {
                    ...
                    // Remote jar-file
                    jarFile = FileUtils.downloadFile(jarUrl.toString(),
                            File.createTempFile("jar_file", ".tmp"), listener);
                }
                
                // Creating
                final JarEntry jarEntry = new JarEntry(JarEntryType.jarEntry,
                        jarFile.getName());
                ...
                while ((zipEntry = zip.getNextEntry()) != null) {
                    ...
                    if (isAllowedPackage(entryName, allowedPackgages)
                            && (zipEntry.isDirectory() || isAllowedExtension(
                                    entryName, allowedExtensions))) {
    ...
    /**
     * Returns whether JAR entry with the specified name is allowed by the
     * extensions list or not.
     *
     * @param entryName
     *            JAR entry name
     * @param allowedExtensions
     *            list of allowed extensions
     * @return true if JAR entry with the specified name is allowed by the
     *         extensions list, false otherwise
     */
    private static boolean isAllowedExtension(final String entryName,
            final List<String> allowedExtensions) {
        if (allowedExtensions == null || allowedExtensions.size() == 0) {
            return true;
        } else {
            final String entryExt = FileUtils.getFileExtPart(entryName, true)
                    .toLowerCase();
     ...
     *            list of allowed packages
     * @return true if JAR entry with the specified name is allowed by the
     *         packages list, false otherwise
     */
    private static boolean isAllowedPackage(final String entryName,
            final List<String> allowedPackgages) {
     ...
     *            ZIP entry
     */
    private static void parseElement(final JarEntry jarEntry,
            final String entryName, final ZipEntry zipEntry) {
        ...
        for (int i = 0; i < path.length; i++) {
            if (i < path.length - 1) {
                ...
                if (child == null) {
                    child = new JarEntry(JarEntryType.packageEntry, path[i],
                            currentLevel);
                ...
                final JarEntry newEntry = new JarEntry(
                        getJarEntryType(path[i]), path[i], currentLevel);
    ...
    /**
     * Returns method caller class. It is not recommended to use this method
     * anywhere but in debugging.
     *
    ...
    public static Class getCallerClass(final int additionalDepth) {
        ...
        // additionalDepth - in case call goes through additional methods this
        // is required
        final int depth = 2 + additionalDepth;
        
        try {
            // We add additional 3 levels of depth due to reflection calls here
            return callStaticMethod("sun.reflect.Reflection", "getCallerClass",
                    depth + 3);
        } catch (final Throwable e) {
            try {
                // Simply use determined depth
                return Class.forName(new Throwable().getStackTrace()[depth]
                        .getClassName());
    ...
    public static String getClassName(final Class classType) {
        ...
        final String fullName = canonicalName != null ? canonicalName
                : classType.toString();
     ...
     *
     * @param fromClass
     *            class to look for the inner class
     * @param innerClassName
     *            inner class name
     * @return inner class with the specified name
     */
    public static Class getInnerClass(final Class fromClass,
     ...
     */
    public static <T> T createInstanceSafely(final String canonicalClassName,
        ...
        try {
            ...
            if (safeMethodsLoggingEnabled) {
                FlatLafLogger.warn(
                        "ReflectionUtils method failed: createInstanceSafely",
                        e);
            }
            return null;
        }
     ...
     */
    public static <T> T createInstance(final String canonicalClassName,
            final Object... arguments) throws ClassNotFoundException,
     ...
     * @return newly created class instance
     */
    public static <T> T createInstanceSafely(final Class theClass,
            final Object... arguments) {
        try {
     ...
     * @throws NoSuchMethodException
     */
    public static <T> T createInstance(final Class theClass,
     ...
     * @throws NoSuchMethodException
     */
    public static Constructor getConstructor(final Class theClass,
            final Class... parameterTypes) throws NoSuchMethodException {
        // todo Constructors priority check (by super types)
        // todo For now some constructor with [Object] arg might be used instead
        // of constructor with [String]
        // todo To avoid issues don't call constructors with same amount of
        // arguments and which are castable to each other
        if (parameterTypes.length == 0) {
            return theClass.getConstructor();
        } else {
            // Constructors can be used only from the topmost class so we don't
            // need to look for them in superclasses
            for (final Constructor constructor : theClass
            ...
            throw new NoSuchMethodException(theClass.getCanonicalName()
                    + argumentTypesToString(parameterTypes));
        }
    }
    
    /**
     * Returns result of called static method. Will return null in case method
     * is void-type.
     *
     * @param canonicalClassName
     *            canonical class name
     ...
     */
    public static <T> T callStaticMethodSafely(final String canonicalClassName,
        ...
        try {
            ...
            if (safeMethodsLoggingEnabled) {
                FlatLafLogger
                        .warn("ReflectionUtils method failed: callStaticMethodSafely",
                                e);
            }
            return null;
        }
     ...
     * @throws IllegalAccessException
     */
    public static <T> T callStaticMethod(final String canonicalClassName,
            final String methodName, final Object... arguments)
            throws ClassNotFoundException, InvocationTargetException,
            NoSuchMethodException, IllegalAccessException {
        return callStaticMethod(getClass(canonicalClassName), methodName,
                arguments);
    }
     ...
     * @return result of called static method
     */
    public static <T> T callStaticMethodSafely(final Class theClass,
            final String methodName, final Object... arguments) {
        try {
     ...
     * @throws IllegalAccessException
     */
    public static <T> T callStaticMethod(final Class theClass,
            final String methodName, final Object... arguments)
     ...
     */
    public static <T> List<T> callMethodsSafely(final List objects,
            final String methodName, final Object... arguments) {
        try {
            ...
            if (safeMethodsLoggingEnabled) {
                FlatLafLogger.warn(
                        "ReflectionUtils method failed: callMethodsSafely", e);
            }
            return null;
        }
    }
     ...
     * @throws IllegalAccessException
     */
    public static <T> List<T> callMethods(final List objects,
            final String methodName, final Object... arguments)
            throws NoSuchMethodException, InvocationTargetException,
            IllegalAccessException {
     ...
     */
    public static Object[] callMethodsSafely(final Object[] objects,
            final String methodName, final Object... arguments) {
        try {
            return callMethods(objects, methodName, arguments);
        } catch (final Throwable e) {
     ...
     * @throws IllegalAccessException
     */
    public static Object[] callMethods(final Object[] objects,
            final String methodName, final Object... arguments)
            throws NoSuchMethodException, InvocationTargetException,
            IllegalAccessException {
     ...
     */
    public static <T> T callMethodSafely(final Object object,
            final String methodName, final Object... arguments) {
        try {
            ...
            if (safeMethodsLoggingEnabled) {
                FlatLafLogger.warn(
                        "ReflectionUtils method failed: callMethodSafely", e);
            }
            return null;
        }
    }
    ...
    /**
     * Calls object's method with the specified name and arguments. If method is
     * not found in the object class all superclasses will be searched for that
     * method. Returns result given by called method.
     *
     * @param object
     *            object instance
     * @param methodName
     ...
     * @throws IllegalAccessException
     */
    public static <T> T callMethod(final Object object,
            final String methodName, final Object... arguments)
            throws NoSuchMethodException, InvocationTargetException,
            IllegalAccessException {
    ...
    /**
     * Returns field getter methor by popular method naming pattern. Basically
     * those are "getFieldName"-like and "isFieldName"-like method names.
     *
     * @param object
     *            object
     * @param field
    ...
    public static Method getFieldGetter(final Class aClass, final String field) {
        ...
        if (get != null) {
            ...
            final Method is = getMethodSafely(aClass,
                    getIsGetterMethodName(field));
     ...
     * @return result given by called method
     */
    public static Method getMethodSafely(final Object object,
            final String methodName, final Object... arguments) {
        return getMethodSafely(object.getClass(), methodName, arguments);
    }
    
    /**
     * Returns object's method with the specified name and arguments. If method
     * is not found in the object class all superclasses will be searched for
     * that method.
     *
     * @param aClass
     *            object class
     ...
     */
    public static Method getMethodSafely(final Class aClass,
            final String methodName, final Object... arguments) {
        try {
            ...
            if (safeMethodsLoggingEnabled) {
                FlatLafLogger.warn(
                        "ReflectionUtils method failed: getMethodSafely", e);
            }
            return null;
        }
    }
     ...
     * @throws IllegalAccessException
     */
    public static Method getMethod(final Class aClass, final String methodName,
            final Object... arguments) throws NoSuchMethodException,
            InvocationTargetException, IllegalAccessException {
        // todo Methods priority check (by super types)
        // todo For now some method with [Object] arg might be used instead of
        // method with [String]
        // todo To avoid issues don't call methods with same amount of arguments
        // and which are castable to each other
        
        // Method key
        final Class[] classTypes = getClassTypes(arguments);
        final String key = aClass.getCanonicalName() + "." + methodName
                + argumentTypesToString(classTypes);
     ...
     * @throws IllegalAccessException
     */
    protected static Method getMethodImpl(final Class aClass,
            final String methodName, final Object[] arguments)
            throws NoSuchMethodException, IllegalAccessException,
            InvocationTargetException {
        // This enhancement was a bad idea and was disabled
        // In case method is protected/private or located in one of superclasses
        // it won't be found
     ...
     * @param currentClass
     *            object class we are looking in for the method
     * @param methodName
     *            method name
     * @param types
     ...
     * @throws NoSuchMethodException
     */
    private static Method getMethod(final Class topClass,
            final Class currentClass, final String methodName,
            final Class[] types) throws IllegalAccessException,
            InvocationTargetException, NoSuchMethodException {
        // Searching for the specified method in object's class or one of its
        // superclasses
        ...
        throw new NoSuchMethodException(topClass.getCanonicalName() + "."
                + methodName + argumentTypesToString(types));
    }
     ...
     * @throws ClassNotFoundException
     */
    public static Class loadClass(final String canonicalClassName)
            throws ClassNotFoundException {
    ...
    public static Class[] getClassTypes(final Object[] arguments) {
        ...
        for (int i = 0; i < arguments.length; i++) {
            parameterTypes[i] = arguments[i] != null ? arguments[i].getClass()
                    : null;
        }
     ...
     *
     * @param type
     *            checked whether is assignable, always not null
     * @param from
     ...
     * @param text
     *            text to search for
     * @return true if one of superclasses contains specified text in its name,
     *         false otherwise
     */
    public static boolean containsInClassOrSuperclassName(final Class theClass,
            final String text) {
        if (theClass == null) {
            return false;
        }
        ...
        if (name != null) {
            return name.contains(text)
                    || containsInClassOrSuperclassName(
                            theClass.getSuperclass(), text);
        } else {
            return containsInClassOrSuperclassName(theClass.getSuperclass(),
                    text);
        }
    }
}