...
public class JarEntry {
    ...
    public static ImageIcon jarIcon = new ImageIcon(
            JarEntry.class.getResource("icons/jar.png"));
    public static ImageIcon packageIcon = new ImageIcon(
            JarEntry.class.getResource("icons/package.png"));
    public static ImageIcon classIcon = new ImageIcon(
            JarEntry.class.getResource("icons/class.png"));
    public static ImageIcon javaIcon = new ImageIcon(
            JarEntry.class.getResource("icons/java.png"));
    public static ImageIcon fileIcon = new ImageIcon(
            JarEntry.class.getResource("icons/file.png"));
    ...
    public ImageIcon getIcon() {
        if (icon != null) {
            ...
            ImageIcon icon = FileUtils.getStandartFileIcon(false,
                    getEntryExtension(), 1f);
            if (icon != null) {
                return icon;
            } else {
                return fileIcon;
    ...
    public boolean isClassEntry(Class classType) {
        return classType != null
                && classType.getCanonicalName().equals(getCanonicalEntryName());
    }
    ...
    public String getCanonicalEntryName() {
        ...
        while (parent != null
                && !parent.getType().equals(JarEntryType.jarEntry)) {
            canonicalName = parent.getName() + "." + canonicalName;
            parent = parent.getParent();
        }
        
        // Removing extension from classes
        if (type.equals(JarEntryType.classEntry)
                || type.equals(JarEntryType.javaEntry)) {
    ...
    public List<JarEntry> getPath() {
        ...
        while (current != null
                && !current.getType().equals(JarEntryType.jarEntry)) {
            path.add(0, current);
    ...
    public boolean equals(Object obj) {
        return obj != null
                && obj instanceof JarEntry
                && ((JarEntry) obj).getCanonicalEntryPath().equals(
