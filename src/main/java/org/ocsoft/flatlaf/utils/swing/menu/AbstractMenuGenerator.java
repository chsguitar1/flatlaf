 ...
 * are made to simplify various Swing menues creation. Possible menu types:
 * WebMenuBar, WebPopupMenu and WebMenu
 *
 * @author Mikle Garin
 * @see org.ocsoft.flatlaf.utils.swing.menu.MenuBarGenerator
 * @see org.ocsoft.flatlaf.utils.swing.menu.MenuGenerator
 * @see org.ocsoft.flatlaf.utils.swing.menu.PopupMenuGenerator
 */
...
public abstract class AbstractMenuGenerator<E extends JComponent> {
    ...
    /**
     * Class near which menu icons are placed. In case it is null path is used
     * as file system path.
     */
    protected Class nearClass;
    
    /**
     * Path to menu icons folder. It is used as path relative to class in case
     * nearClass variable is not null.
     */
     ...
     *
     * @param path
     *            path to menu icons folder in file system
     * @param extension
     *            menu icons format
     */
     ...
     *            menu icons format
     */
    public void setIconSettings(final Class nearClass, final String path,
    ...
    public WebMenuItem addItem(final String text,
            final ActionListener actionListener) {
        return addItem(defaultIcon, text, defaultHotkey, defaultEnabled,
                actionListener);
    }
    
    public WebMenuItem addItem(final String text, final HotkeyData hotkey,
            final ActionListener actionListener) {
        return addItem(defaultIcon, text, hotkey, defaultEnabled,
                actionListener);
    }
    
    public WebMenuItem addItem(final String text, final boolean enabled,
            final ActionListener actionListener) {
        return addItem(defaultIcon, text, defaultHotkey, enabled,
                actionListener);
    }
    ...
    public WebMenuItem addItem(final Object icon, final String text,
            final ActionListener actionListener) {
        return addItem(icon, text, defaultHotkey, defaultEnabled,
                actionListener);
    }
    
    public WebMenuItem addItem(final Object icon, final String text,
            final HotkeyData hotkey, final ActionListener actionListener) {
     ...
     *
     * @param icon
     *            menu item icon, can be either String icon name, ImageIcon,
     *            Image, image File or image URL
     * @param text
     *            menu item text
     * @param hotkey
     *            menu item accelerator
     * @param enabled
     *            whether menu item is enabled or not
    ...
    public WebMenuItem addItem(final Object icon, final String text,
            ...
            final ActionListener actionListener) {
        final WebMenuItem item = createItem(icon, text, hotkey, enabled,
                actionListener);
        getMenu().add(item);
        return item;
    }
     ...
     * @return newly created menu item
     */
    protected WebMenuItem createItem(final Object icon, final String text,
            final HotkeyData hotkey, final boolean enabled,
            final ActionListener actionListener) {
    ...
    public WebCheckBoxMenuItem addCheckItem(final String text,
            final boolean selected, final ActionListener actionListener) {
        return addCheckItem(defaultIcon, text, defaultHotkey, defaultEnabled,
                selected, actionListener);
    }
    
    public WebCheckBoxMenuItem addCheckItem(final String text,
            final HotkeyData hotkey, final boolean selected,
            final ActionListener actionListener) {
        return addCheckItem(defaultIcon, text, hotkey, defaultEnabled,
                selected, actionListener);
    }
    ...
    public WebCheckBoxMenuItem addCheckItem(final String text,
            ...
            final ActionListener actionListener) {
        return addCheckItem(defaultIcon, text, defaultHotkey, enabled,
                selected, actionListener);
    }
    ...
    public WebCheckBoxMenuItem addCheckItem(final String text,
            final HotkeyData hotkey, final boolean enabled,
            final boolean selected, final ActionListener actionListener) {
        return addCheckItem(defaultIcon, text, hotkey, enabled, selected,
                actionListener);
    }
    
    public WebCheckBoxMenuItem addCheckItem(final Object icon,
            final String text, final boolean selected,
            final ActionListener actionListener) {
        return addCheckItem(icon, text, defaultHotkey, defaultEnabled,
                selected, actionListener);
    }
    
    public WebCheckBoxMenuItem addCheckItem(final Object icon,
            final String text, final HotkeyData hotkey, final boolean selected,
            final ActionListener actionListener) {
        return addCheckItem(icon, text, hotkey, defaultEnabled, selected,
                actionListener);
    }
    
    public WebCheckBoxMenuItem addCheckItem(final Object icon,
            final String text, final boolean enabled, final boolean selected,
            final ActionListener actionListener) {
        return addCheckItem(icon, text, defaultHotkey, enabled, selected,
                actionListener);
    }
     ...
     *
     * @param icon
     *            checkbox menu item icon, can be either String icon name,
     *            ImageIcon, Image, image File or image URL
     * @param text
     *            checkbox menu item text
     * @param hotkey
     *            checkbox menu item accelerator
     * @param enabled
     *            whether checkbox menu item is enabled or not
     * @param selected
     *            whether checkbox menu item is selected or not
     * @param actionListener
    ...
    public WebCheckBoxMenuItem addCheckItem(final Object icon,
            ...
            final boolean selected, final ActionListener actionListener) {
        final WebCheckBoxMenuItem item = createCheckItem(icon, text, hotkey,
                enabled, selected, actionListener);
        getMenu().add(item);
        return item;
    }
     ...
     * @return newly created checkbox menu item
     */
    protected WebCheckBoxMenuItem createCheckItem(final Object icon,
            final String text, final HotkeyData hotkey, final boolean enabled,
            final boolean selected, final ActionListener actionListener) {
    ...
    public WebRadioButtonMenuItem addRadioItem(final String text,
            final boolean selected, final ActionListener actionListener) {
        return addRadioItem(defaultIcon, text, defaultHotkey, defaultEnabled,
                selected, actionListener);
    }
    ...
    public WebRadioButtonMenuItem addRadioItem(final String text,
            final HotkeyData hotkey, final boolean selected,
            final ActionListener actionListener) {
        return addRadioItem(defaultIcon, text, hotkey, defaultEnabled,
                selected, actionListener);
    }
    ...
    public WebRadioButtonMenuItem addRadioItem(final String text,
            final boolean enabled, final boolean selected,
            final ActionListener actionListener) {
        return addRadioItem(defaultIcon, text, defaultHotkey, enabled,
                selected, actionListener);
    }
    ...
    public WebRadioButtonMenuItem addRadioItem(final String text,
            final HotkeyData hotkey, final boolean enabled,
            final boolean selected, final ActionListener actionListener) {
        return addRadioItem(defaultIcon, text, hotkey, enabled, selected,
                actionListener);
    }
    ...
    public WebRadioButtonMenuItem addRadioItem(final Object icon,
            final String text, final boolean selected,
            final ActionListener actionListener) {
        return addRadioItem(icon, text, defaultHotkey, defaultEnabled,
                selected, actionListener);
    }
    ...
    public WebRadioButtonMenuItem addRadioItem(final Object icon,
            final String text, final HotkeyData hotkey, final boolean selected,
            final ActionListener actionListener) {
        return addRadioItem(icon, text, hotkey, defaultEnabled, selected,
                actionListener);
    }
    ...
    public WebRadioButtonMenuItem addRadioItem(final Object icon,
            final String text, final boolean enabled, final boolean selected,
            final ActionListener actionListener) {
        return addRadioItem(icon, text, defaultHotkey, enabled, selected,
                actionListener);
    }
     ...
     *
     * @param icon
     *            radio button menu item icon, can be either String icon name,
     *            ImageIcon, Image, image File or image URL
     * @param text
     *            radio button menu item text
     * @param hotkey
     *            radio button menu item accelerator
     * @param enabled
     *            whether radio button menu item is enabled or not
     * @param selected
     *            whether radio button menu item is selected or not
     * @param actionListener
    ...
    public WebRadioButtonMenuItem addRadioItem(final Object icon,
            final String text, final HotkeyData hotkey, final boolean enabled,
            final boolean selected, final ActionListener actionListener) {
        final WebRadioButtonMenuItem item = createRadioItem(icon, text, hotkey,
                enabled, selected, actionListener);
        getMenu().add(item);
        return item;
    }
     ...
     * @return newly created radio button menu item
     */
    protected WebRadioButtonMenuItem createRadioItem(final Object icon,
            final String text, final HotkeyData hotkey, final boolean enabled,
            final boolean selected, final ActionListener actionListener) {
     ...
     * <p/>
     * Returned menu generator will have the same settings as current one. You
     * can modify them if you need though.
     *
     * @param icon
     *            menu icon, can be either String icon name, ImageIcon, Image,
     ...
     */
    protected WebMenu createSubMenu(final Object icon, final String text,
            final boolean enabled, final ActionListener actionListener) {
    ...
    /**
     * Starts grouping menu items. All items created after this call and before
     * {@code closeGroup()} call will get grouped.
     *
     ...
     *
     * @param icon
     *            can be either String icon name, ImageIcon, Image, image File
     *            or image URL
    ...
    public ImageIcon getIcon(final Object icon) {
        if (icon != null) {
            if (icon instanceof String) {
                try {
                    if (nearClass != null) {
                        return new ImageIcon(nearClass.getResource(path + icon
                                + extension));
                    } else {
                        return new ImageIcon(
                                new File(path, icon + extension)
                                        .getAbsolutePath());
                    }
                } catch (final Throwable e) {
                    FlatLafLogger.warn("Unable to find menu icon for path: "
                            + path + icon + extension, e);
                    return null;
                }
                ...
                FlatLafLogger
                        .warn("Unknown icon object type provided: " + icon);
                return null;
            }
        } else {
            return null;
