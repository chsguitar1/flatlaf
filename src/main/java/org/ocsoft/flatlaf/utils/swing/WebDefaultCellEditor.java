...
public class WebDefaultCellEditor<C extends JComponent> extends
        AbstractCellEditor implements TableCellEditor, TreeCellEditor {
    ...
    protected class EditorDelegate<T> implements ActionListener, ItemListener,
            Serializable {
        protected T value;
        ...
        public boolean isCellEditable(final EventObject anEvent) {
            if (anEvent == null || anEvent instanceof ActionEvent) {
                ...
                return clickCountToStart >= 0
                        && mouseEvent.getClickCount() >= clickCountToStart;
            } else {
                return false;
            }
        }
