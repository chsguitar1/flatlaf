...
public final class TimeUtils {
    ...
    /**
     * Returns time passed since either last pin request or last time request if
     * total is false. Otherwise always returns time passed since last pin
     * request.
     *
     * @param total
    ...
    /**
     * Writes time passed since either last pin request or last time request to
     * log.
     */
    ...
    /**
     * Writes time passed since either last pin request or last time request if
     * total is false to log. Otherwise always writes time passed since last pin
     * request.
     *
     * @param total
     *            should always write time passed since last pin request or not
     */
    ...
    /**
     * Writes time passed since either last pin request or last time request if
     * total is false to log with specified prefix. Otherwise always writes time
    ...
    public static void showPassedTime(final boolean total, final String prefix) {
        final long time = currentTime();
        FlatLafLogger.info(TimeUtils.class, prefix
                + (total ? time - pinnedTime : time - lastTime));
        lastTime = time;
    }
    ...
    /**
     * Returns nanotime passed since either last pin request or last nanotime
     * request.
     *
    ...
    /**
     * Returns nanotime passed since either last pin request or last nanotime
     * request if total is false. Otherwise always returns nanotime passed since
     * last pin request.
     *
     * @param total
     *            should always return time passed since last pin request or not
    ...
    public static long getPassedNanoTime(final boolean total) {
        ...
        final long passedTime = total ? time - pinnedNanoTime : time
                - lastNanoTime;
        lastNanoTime = time;
        return passedTime;
    }
    ...
    /**
     * Writes nanotime passed since either last pin request or last nanotime
     * request to log.
     */
    ...
    /**
     * Writes nanotime passed since either last pin request or last nanotime
     * request to log with specified prefix.
     *
     * @param prefix
     *            output string prefix
     */
    ...
    /**
     * Writes nanotime passed since either last pin request or last nanotime
     * request if total is false to log. Otherwise always writes nanotime passed
     * since last pin request.
     *
     * @param total
     *            should always write nanotime passed since last pin request or
     *            not
     */
    ...
    /**
     * Writes nanotime passed since either last pin request or last nanotime
     * request if total is false to log with specified prefix. Otherwise always
    ...
    public static void showPassedNanoTime(final boolean total,
        ...
        final long time = currentNanoTime();
        FlatLafLogger.info(TimeUtils.class, prefix
                + (total ? time - pinnedNanoTime : time - lastNanoTime));
        lastNanoTime = time;
    }
    ...
    /**
     * Returns true if date contained in Calendar and specified date both
    ...
    /**
     * Returns true if date contained in Calendar and specified time both
     * represent the same day.
     *
     * @param calendar
     *            calendar
     ...
     *
     * @param calendar
     *            calendar that should be changed
     */
