...
public final class ComponentStyle implements Serializable {
    /**
     * Style component type. Refers to component type this style belongs to.
     */
    private SupportedComponent type;
    
    /**
     * Unique component style ID. Default component style always has "default"
     * ID.
     */
    private String id;
    
    /**
     * Another component style ID which is extended by this style. You can
     * specify any existing style ID here to extend it.
     */
    private String extendsId;
    
    /**
     * Component settings. Contains field-value pairs which will be applied to
     * component fields.
     */
    private Map<String, Object> componentProperties;
    
    /**
     * Component UI settings. Contains field-value pairs which will be applied
     * to component UI fields.
     */
    private Map<String, Object> uiProperties;
    
    /**
     * Component painters settings. Contains list of painter style infromation
     * objects.
     */
    ...
    /**
     * Sets extended component style ID. Set this to null in case you don't want
     * to extend any style.
     *
     * @param id
     *            new extended component style ID
     */
