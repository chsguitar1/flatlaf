...
public final class SkinInfo implements Serializable {
    /**
     * Unique skin ID. Used to collect and manage skins within StyleManager.
     */
    private String id;
    
    /**
     * Short skin name. Might be used to display skin selection and options.
     */
    private String name;
    
    /**
     * Skin description. You are free to put here any description you like.
     */
    ...
    /**
     * List of OS supported by this skin separated by "," character. List of OS
     * IDs constants can be found in SystemUtils class. If skin supports all OS
     * you can simply put "all" here.
     */
    private String supportedSystems;
    
    /**
     * Skin class canonical name. Used to locate included resources.
     */
    @XStreamAlias("class")
    private String skinClass;
    
    /**
     * List of skin styles. This list contains all styling settings and painter
     * directions.
     */
    @XStreamImplicit
     ...
     *
     * @param component
     *            component we are looking style for
     * @param type
    ...
    public ComponentStyle getStyle(final JComponent component,
        ...
        final Map<String, ComponentStyle> componentStyles = stylesCache
                .get(type);
        if (componentStyles != null) {
            ...
            if (style != null) {
                ...
                FlatLafLogger.error(this, "Unable to find style with ID \""
                        + styleId + "\" for component: " + component);
                return componentStyles
                        .get(ComponentStyleConverter.DEFAULT_STYLE_ID);
            }
        } else {
            return null;
        }
