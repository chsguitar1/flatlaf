 ...
 * skins and can install/change them in runtime.
 *
 * @author Mikle Garin
 * @see <a
...
public class StyleManager {
    /**
     * todo 1. Probably add "setCustomUIStyle" to override settings provided by
     * skin
     */
    ...
    /**
     * Static class aliases processing. This allows StyleManager usage without
     * its initialization.
     */
    static {
        // Class aliases
    ...
    /**
     * Skins applied for each specific skinnable component. Used to determine
     * skinnable components, update them properly and detect their current skin.
    ...
    /**
     * Custom painter properties. These properties may be specified for each
     * separate component. Map structure: JComponent -> painterId ->
     * propertyName -> propertyValue
     */
    protected static final Map<JComponent, Map<String, Map<String, Object>>> customPainterProperties = new WeakHashMap<JComponent, Map<String, Map<String, Object>>>();
    
    /**
     * Custom component painters. These are the painters set from the code and
     * they replace default painters provided by skin. Map structure: JComponent
     * -> Painter ID -> Painter
     */
    protected static final Map<JComponent, Map<String, Painter>> customPainters = new WeakHashMap<JComponent, Map<String, Painter>>();
    
    /**
     * Default WebLaF skin. Skin used by default when no other skins provided.
     * This skin can be set before WebLaF initialization to avoid unnecessary UI
     * updates afterwards.
     */
    protected static WebLafSkin defaultSkin = null;
    
    /**
     * Currently used skin. This skin is applied to all newly created components
     * styled by WebLaF except customized ones.
     */
     ...
     * <p/>
     * In case strick checks are enabled any incorrect properties or painters
     * getter and setter calls will cause exceptions. These exceptions will not
     * cause UI to halt but they will properly inform about missing styles,
     * incorrect settings etc.
     * <p/>
     * It is highly recommended to keep this property enabled to see and fix all
     * problems right away.
     */
    ...
    /**
     * Performs skin support check and throws an exception if skin is not
     * supported.
     *
     * @param skin
     *            skin to check
    ...
    protected static void checkSupport(final WebLafSkin skin) {
        ...
        if (!skin.isSupported()) {
            throw new StyleException("Skin \"" + skin.getName()
    ...
    public static WebLafSkin createSkin(final Class skinClass) {
        try {
            ...
            throw new StyleException(
                    "Unable to initialize skin from its class", e);
        }
    }
    ...
    /**
     * Applies default skin to all existing skinnable components. This skin will
     * also be applied to all skinnable components created afterwards.
     *
    ...
    /**
     * Applies specified skin to all existing skinnable components. This skin
     * will also be applied to all skinnable components created afterwards.
     *
     * @param skinClassName
    ...
    public static WebLafSkin applySkin(final WebLafSkin skin) {
        ...
        for (final Map.Entry<JComponent, WebLafSkin> entry : appliedSkins
                .entrySet()) {
    ...
    /**
     * Applies specified skin to the skinnable component. todo Do not replace
     * custom applied skins when current skin changed?
     *
     * @param component
     *            component to apply skin to
     * @param skin
     ...
     */
    public static <T> T getPainterPropertyValue(final JComponent component,
            final String key) {
    ...
    public static <T> T getPainterPropertyValue(final JComponent component,
        ...
        final WebLafSkin skin = appliedSkins.get(component);
        return skin != null ? (T) skin.getPainterPropertyValue(component,
                painterId, key) : null;
    }
    
    /**
     * Sets custom value for painter property for the specified component. This
     * tricky method uses component skin to set the specified property into
     * component painter.
     *
     * @param component
     ...
     * @param <T>
     *            custom style property value type
     * @return old custom style property value
     */
    public static <T> T setCustomPainterProperty(final JComponent component,
     ...
     */
    public static <T> T setCustomPainterProperty(final JComponent component,
            final String painterId, final String key, final T value) {
        // Retrieving custom properties map
        Map<String, Map<String, Object>> allProperties = customPainterProperties
                .get(component);
        ...
        // Applying custom style property if there is a skin applied to this
        // component
    ...
    /**
     * Returns all custom painter properties. Map structure: JComponent ->
     * painterId -> propertyName -> propertyValue
     *
    ...
    /**
     * Returns all custom painter properties for the specified component. Map
     * structure: painterId -> propertyName -> propertyValue
     *
     * @param component
     *            component to retrieve custom properties for
     * @return all custom painter properties for the specified component
     */
    public static Map<String, Map<String, Object>> getCustomPainterProperties(
            final JComponent component) {
        return customPainterProperties.get(component);
    }
    
    /**
     * Clears all custom painter properties for the specified component. This is
     * required when painter changes to avoid setting unexisting variables into
     * painter.
     *
     * @param component
    ...
    public static void clearCustomPainterProperties(final JComponent component) {
        final Map<String, Map<String, Object>> properties = customPainterProperties
                .get(component);
        if (properties != null) {
    ...
    /**
     * Sets custom default painter for the specified component. You should call
     * this method when setting painter outside of the UI to avoid
     *
     * @param component
     ...
     */
    public static <T extends Painter> T setCustomPainter(
            final JComponent component, final T painter) {
        // todo Change ID to null
        return setCustomPainter(component, DEFAULT_PAINTER_ID, painter);
    }
    
    /**
     * Sets custom painter for the specified component. You should call this
     * method when setting painter outside of the UI to avoid
     *
     * @param component
     *            component to set painter for
     * @param id
     ...
     */
    public static <T extends Painter> T setCustomPainter(
            final JComponent component, final String id, final T painter) {
     ...
     */
    public static Map<String, Painter> getCustomPainters(
            final JComponent component) {
    ...
    /**
     * Sets component style ID if component or its UI is instance of Styleable
     * interface. This might be useful in cases when you cannot be sure about
     * component type but want to provide style if possible.
     *
     * @param component
     *            component to apply style ID to
     * @param styleId
     *            style ID
     * @return true if style ID was successfully applied, false otherwise
     */
    public static boolean setStyleId(final Component component,
