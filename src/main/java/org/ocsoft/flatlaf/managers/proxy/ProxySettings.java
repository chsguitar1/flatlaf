...
public class ProxySettings implements Serializable, Cloneable {
     ...
     */
    public ProxySettings(final String proxyHost, final String proxyPort,
            final String proxyLogin, final String proxyPassword) {
        super();
     ...
     *
     * @param useProxyAuthentification
     *            whether proxy requires authentification or not
     */
    public void setUseProxyAuthentification(
            final boolean useProxyAuthentification) {
    ...
    public String toString() {
        if (isUseProxy()) {
            ...
            final String auth = useAuth ? getProxyLogin() + ":"
                    + TextUtils.createString("*", getProxyPassword().length())
                    + "@" : "";
            return "ProxySettings [ " + auth + getProxyHost() + ":"
                    + getProxyPort() + " ]";
        } else {
