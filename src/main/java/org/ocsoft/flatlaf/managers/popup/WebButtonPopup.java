...
public class WebButtonPopup extends WebPopup {
    private static final List<String> BUTTON_PROPERTIES = Arrays.asList(
    ...
    public WebButtonPopup(final WebButton button, final PopupWay popupWay) {
        ...
        button.addAncestorListener(new AncestorAdapter() {
            ...
            public void ancestorRemoved(final AncestorEvent event) {
                // Hiding popup properly when button is removed from visible
                // container somehow
                hidePopup(false);
            }
    ...
    public void updateBounds() {
        if (isShowing() && button.isShowing()) {
            final Point rl = SwingUtils
                    .getRelativeLocation(button, getParent());
            final Dimension ps = getPreferredSize();
            
            // Bottom popup
            if (popupWay.equals(PopupWay.downLeft)) {
                setBounds(new Rectangle(new Point(rl.x + button.getWidth()
                        - ps.width, rl.y), ps));
            } else if (popupWay.equals(PopupWay.downCenter)) {
                setBounds(new Rectangle(new Point(rl.x + button.getWidth() / 2
                        - ps.width / 2, rl.y), ps));
            } else if (popupWay.equals(PopupWay.downRight)) {
            ...
            // Top popup
                ...
                setBounds(new Rectangle(new Point(rl.x + button.getWidth()
                        - ps.width, rl.y + button.getHeight() - ps.height), ps));
            } else if (popupWay.equals(PopupWay.upCenter)) {
                setBounds(new Rectangle(new Point(rl.x + button.getWidth() / 2
                        - ps.width / 2, rl.y + button.getHeight() - ps.height),
                        ps));
            } else if (popupWay.equals(PopupWay.upRight)) {
                setBounds(new Rectangle(new Point(rl.x, rl.y
                        + button.getHeight() - ps.height), ps));
            }
            // Left popup
                ...
                setBounds(new Rectangle(new Point(rl.x + button.getWidth()
                        - ps.width, rl.y + button.getHeight() / 2 - ps.height
                        / 2), ps));
            } else if (popupWay.equals(PopupWay.leftDown)) {
                setBounds(new Rectangle(new Point(rl.x + button.getWidth()
                        - ps.width, rl.y), ps));
            ...
            // Right popup
                ...
                setBounds(new Rectangle(new Point(rl.x, rl.y
                        + button.getHeight() / 2 - ps.height / 2), ps));
            } else if (popupWay.equals(PopupWay.rightDown)) {
    ...
    public Shape getPopupShape(final WebButtonPopup c) {
        ...
        if (isUpDown() && cw == bw || isLeftRight() && ch == bh) {
            shape = LafUtils.createRoundedShape(round,
                    p(shadeWidth, shadeWidth), p(cw - shadeWidth, shadeWidth),
                    p(cw - shadeWidth, ch - shadeWidth),
                    p(shadeWidth, ch - shadeWidth));
        }
        // Bottom popup
        else if (popupWay.equals(PopupWay.downLeft)) {
            shape = LafUtils.createRoundedShape(round,
                    p(cw - bw + shadeWidth, shadeWidth),
                    p(cw - shadeWidth, shadeWidth),
                    p(cw - shadeWidth, ch - shadeWidth),
                    p(shadeWidth, ch - shadeWidth), p(shadeWidth, bh),
                    p(cw - bw + shadeWidth, bh));
        } else if (popupWay.equals(PopupWay.downCenter)) {
            final int shear = bw % 2;
            shape = LafUtils.createRoundedShape(round,
                    p(cw / 2 - bw / 2 - shear + shadeWidth, shadeWidth),
                    p(cw / 2 + bw / 2 - shadeWidth, shadeWidth),
                    p(cw / 2 + bw / 2 - shadeWidth, bh),
                    p(cw - shadeWidth, bh),
                    p(cw - shadeWidth, ch - shadeWidth),
                    p(shadeWidth, ch - shadeWidth), p(shadeWidth, bh),
            ...
            shape = LafUtils.createRoundedShape(round,
                    p(shadeWidth, shadeWidth), p(bw - shadeWidth, shadeWidth),
                    p(bw - shadeWidth, bh), p(cw - shadeWidth, bh),
                    p(cw - shadeWidth, ch - shadeWidth),
                    p(shadeWidth, ch - shadeWidth));
        }
        // Top popup
            ...
            shape = LafUtils.createRoundedShape(round,
                    p(shadeWidth, shadeWidth), p(cw - shadeWidth, shadeWidth),
                    p(cw - shadeWidth, ch - shadeWidth),
                    p(cw - bw + shadeWidth, ch - shadeWidth),
                    p(cw - bw + shadeWidth, ch - bh), p(shadeWidth, ch - bh));
        } else if (popupWay.equals(PopupWay.upCenter)) {
            final int shear = bw % 2;
            shape = LafUtils.createRoundedShape(round,
                    p(shadeWidth, shadeWidth), p(cw - shadeWidth, shadeWidth),
                    p(cw - shadeWidth, ch - bh),
                    p(cw / 2 + bw / 2 - shadeWidth, ch - bh),
                    p(cw / 2 + bw / 2 - shadeWidth, ch - shadeWidth),
                    p(cw / 2 - bw / 2 - shear + shadeWidth, ch - shadeWidth),
                    p(cw / 2 - bw / 2 - shear + shadeWidth, ch - bh),
                    p(shadeWidth, ch - bh));
        } else if (popupWay.equals(PopupWay.upRight)) {
            shape = LafUtils.createRoundedShape(round,
                    p(shadeWidth, shadeWidth), p(cw - shadeWidth, shadeWidth),
                    p(cw - shadeWidth, ch - bh), p(bw - shadeWidth, ch - bh),
                    p(bw - shadeWidth, ch - shadeWidth),
                    p(shadeWidth, ch - shadeWidth));
        }
        // Left popup
        else if (popupWay.equals(PopupWay.leftUp)) {
            shape = LafUtils.createRoundedShape(round,
                    p(shadeWidth, shadeWidth), p(cw - bw, shadeWidth),
                    p(cw - bw, ch - bh + shadeWidth),
                    p(cw - shadeWidth, ch - bh + shadeWidth),
                    p(cw - shadeWidth, ch - shadeWidth),
                    p(shadeWidth, ch - shadeWidth));
        } else if (popupWay.equals(PopupWay.leftCenter)) {
            ...
            shape = LafUtils
                    .createRoundedShape(
                            round,
                            p(shadeWidth, shadeWidth),
                            p(cw - bw, shadeWidth),
                            p(cw - bw, ch / 2 - bh / 2 + shadeWidth),
                            p(cw - shadeWidth, ch / 2 - bh / 2 + shadeWidth),
                            p(cw - shadeWidth, ch / 2 + bh / 2 + shear
                                    - shadeWidth),
                            p(cw - bw, ch / 2 + bh / 2 + shear - shadeWidth),
                            p(cw - bw, ch - shadeWidth),
                            p(shadeWidth, ch - shadeWidth));
        } else if (popupWay.equals(PopupWay.leftDown)) {
            shape = LafUtils.createRoundedShape(round,
                    p(shadeWidth, shadeWidth), p(cw - shadeWidth, shadeWidth),
                    p(cw - shadeWidth, bh - shadeWidth),
                    p(cw - bw, bh - shadeWidth), p(cw - bw, ch - shadeWidth),
                    p(shadeWidth, ch - shadeWidth));
        }
        // Right popup
        else if (popupWay.equals(PopupWay.rightUp)) {
            shape = LafUtils.createRoundedShape(round,
                    p(shadeWidth, ch - bh + shadeWidth),
                    p(bw, ch - bh + shadeWidth), p(bw, shadeWidth),
                    p(cw - shadeWidth, shadeWidth),
                    p(cw - shadeWidth, ch - shadeWidth),
                    p(shadeWidth, ch - shadeWidth));
        } else if (popupWay.equals(PopupWay.rightCenter)) {
            final int shear = bh % 2;
            shape = LafUtils.createRoundedShape(round,
                    p(shadeWidth, ch / 2 - bh / 2 + shadeWidth),
                    p(bw, ch / 2 - bh / 2 + shadeWidth), p(bw, shadeWidth),
                    p(cw - shadeWidth, shadeWidth),
                    p(cw - shadeWidth, ch - shadeWidth),
                    p(bw, ch - shadeWidth),
                    p(bw, ch / 2 + bh / 2 + shear - shadeWidth),
                    p(shadeWidth, ch / 2 + bh / 2 + shear - shadeWidth));
        } else if (popupWay.equals(PopupWay.rightDown)) {
            shape = LafUtils.createRoundedShape(round,
                    p(shadeWidth, shadeWidth), p(cw - shadeWidth, shadeWidth),
                    p(cw - shadeWidth, ch - shadeWidth),
                    p(bw, ch - shadeWidth), p(bw, bh - shadeWidth),
    ...
    private boolean isDown() {
        return popupWay.equals(PopupWay.downLeft)
                || popupWay.equals(PopupWay.downCenter)
                || popupWay.equals(PopupWay.downRight);
    }
    
    private boolean isUp() {
        return popupWay.equals(PopupWay.upLeft)
                || popupWay.equals(PopupWay.upCenter)
    ...
    private boolean isRight() {
        return popupWay.equals(PopupWay.rightUp)
                || popupWay.equals(PopupWay.rightCenter)
                || popupWay.equals(PopupWay.rightDown);
    }
    
    private boolean isLeft() {
        return popupWay.equals(PopupWay.leftUp)
                || popupWay.equals(PopupWay.leftCenter)
     ...
     */
    protected class WebButtonPopupPainter extends
            WebPanelPainter<WebButtonPopup> {
        /**
         * {@inheritDoc}
         */
        @Override
        public void paint(final Graphics2D g2d, final Rectangle bounds,
                final WebButtonPopup c) {
            LafUtils.drawCustomWebBorder(
                    g2d,
                    c,
                    getPopupShape(c),
                    button.isFocusable() && button.isDrawFocus() && focused ? FlatLafStyleConstants.fieldFocusColor
                            : FlatLafStyleConstants.shadeColor, button
                            .getShadeWidth(), true, isWebColoredBackground());
        }
    }
}