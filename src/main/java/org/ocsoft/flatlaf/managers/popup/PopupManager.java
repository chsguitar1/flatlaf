 ...
 * @see WebPopup
 * @see WebButtonPopup
 * @see org.ocsoft.flatlaf.managers.notification.WebInnerNotification
 */
...
public class PopupManager {
     ...
     *
     * @param component
     *            component used to determine root pane for which modal popup
     *            will be displayed
     * @param popup
     *            popup to display
     */
     ...
     *            popup to display
     * @param transferFocus
     *            whether to transfer focus to content of the displayed popup or
     *            not
     */
    public static void showPopup(final Component component,
            final WebPopup popup, final boolean transferFocus) {
     ...
     *
     * @param rootPane
     *            root pane used to display popup
     * @param popup
     *            popup to display
     * @param transferFocus
     *            whether to transfer focus to content of the displayed popup or
     *            not
     */
    public static void showPopup(final JRootPane rootPane,
            final WebPopup popup, final boolean transferFocus) {
    ...
    public static PopupLayer getPopupLayer(final JRootPane rootPane) {
        ...
        if (popupLayers.containsKey(rootPane)) {
            ...
            if (layeredPane == null) {
                throw new RuntimeException(
                        "Popup layer can be installed only into window or applet with JLayeredPane");
            }
     ...
     *            popup to display
     * @param hfill
     *            whether popup should fill the whole available width or not
     * @param vfill
     *            whether popup should fill the whole available height or not
     */
    public static void showModalPopup(final Component component,
            final WebPopup popup, final boolean hfill, final boolean vfill) {
     ...
     *
     * @param rootPane
     *            root pane used to display modal popup
     * @param popup
     *            popup to display
     * @param hfill
     *            whether popup should fill the whole available width or not
     ...
     *            whether popup should fill the whole available height or not
     */
    public static void showModalPopup(final JRootPane rootPane,
            final WebPopup popup, final boolean hfill, final boolean vfill) {
     ...
     *
     * @param popupLayer
     *            popup layer to install
     * @param rootPane
     *            root pane for which popup layer should be installed
     * @param layeredPane
     *            window's layered pane
     */
    protected static void installPopupLayer(final PopupLayer popupLayer,
            final JRootPane rootPane, final JLayeredPane layeredPane) {
