 ...
 * @see org.ocsoft.flatlaf.managers.settings.SettingsManager#registerSettingsProcessor(Class, Class)
 * @see org.ocsoft.flatlaf.managers.settings.ComponentSettingsManager
 * @see org.ocsoft.flatlaf.managers.settings.ComponentSettingsManager#registerSettingsProcessor(Class, Class)
 */
