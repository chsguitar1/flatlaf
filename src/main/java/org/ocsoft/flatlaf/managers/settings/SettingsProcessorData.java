...
public class SettingsProcessorData {
     ...
     *            whether to apply settings changes to the component or not
     */
    public SettingsProcessorData(final Component component, final String group,
     ...
     * component or not.
     *
     * @return true if initial available settings should be loaded into the
    ...
    /**
     * Sets whether to load initial available settings into the component or
     * not.
     *
     * @param loadInitialSettings
     *            whether to load initial available settings into the component
    ...
    /**
     * Returns whether settings changes should be applied to the component or
     * not.
     *
     * @return true if settings changes should be applied to the component,
     *         false otherwise
     */
