...
public class SettingsConverter extends ReflectionConverter {
    ...
    /**
     * Constructs SettingsConverter with the specified mapper and reflection
     * provider.
     *
     * @param mapper
     *            mapper
     ...
     *            reflection provider
     */
    public SettingsConverter(final Mapper mapper,
    ...
    public void marshal(final Object source,
        ...
        // Converting settings
        for (final Map.Entry<String, Object> entry : settingsGroup
                .getSettings().entrySet()) {
            // If key text is proper for node name it will be used, otherwise it
            // will be separated
            ...
            if (value == null) {
                ...
                final String serializedType = mapper.serializedClass(value
                        .getClass());
    ...
    public Object unmarshal(final HierarchicalStreamReader reader,
        ...
        final SettingsGroup settingsGroup = new SettingsGroup(
        ...
        while (reader.hasMoreChildren()) {
            ...
            if (nodeName.equals("entry") && reader.getAttributeCount() == 0) {
                ...
                try {
                    ...
                    final String actualType = typeAttribute != null ? typeAttribute
                            : nodeName;
                    if (actualType.equals(NULL_TYPE)) {
                        ...
                        settings.put(key,
                                context.convertAnother(settings, type));
                    }
                } catch (final Throwable e) {
                    if (SettingsManager.isLoggingEnabled()) {
                        FlatLafLogger.error(this,
                                "Unable to load settings entry for group \""
