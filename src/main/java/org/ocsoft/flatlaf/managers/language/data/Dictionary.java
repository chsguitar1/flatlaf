...
public final class Dictionary implements Serializable {
    ...
    public Dictionary(final String prefix, final String name,
            final String author, final String creationDate) {
        super();
        setId();
        setPrefix(prefix);
        setName(name);
    ...
    public Dictionary(final String prefix, final String name,
            final String author, final String creationDate, final String notes) {
        super();
        setId();
        setPrefix(prefix);
        setName(name);
    ...
    public Record addRecord(final String key, final String language,
            final String text) {
        return addRecord(key, new Value(language, text));
    }
    
    public Record addRecord(final String key, final String language,
            final Character mnemonic, final String text) {
    ...
    public boolean equals(final Object obj) {
        return obj != null && obj instanceof Dictionary
                && ((Dictionary) obj).getId().equals(getId());
    }
    ...
    public String toString() {
        return (name != null ? name + " " : "")
                + (size() > 0 ? " (records: " + size() + ")" : "")
                + (subdictionaries() > 0 ? " (subdictionaries: "
                        + subdictionaries() + ")" : "");
    }
}