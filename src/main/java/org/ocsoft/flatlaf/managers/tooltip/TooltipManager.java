 ...
 * any possible content (would it be simple text or some JComponent ancestor) or
 * show one-time tooltips at custom location inside any window. Also this
 * manager is integrated with HotkeyManager and provides an opportunity to
 * automatically show components hotkeys on their tooltips set with this class.
 *
 * @author Mikle Garin
...
public class TooltipManager {
    ...
    public static void hideAllTooltips() {
        ...
        for (final Component component : CollectionUtils.copy(webTooltips
                .keySet())) {
            // Stopping any timers
            ...
            if (list != null && list.size() > 0) {
                for (final WebCustomTooltip tooltip : CollectionUtils
                        .copy(list)) {
    ...
    public static WebCustomTooltip setTooltip(final Component component,
    ...
    public static WebCustomTooltip setTooltip(final Component component,
            final Icon icon, final String tooltip, final TooltipWay tooltipWay) {
        return setTooltip(component, icon, tooltip, tooltipWay, defaultDelay);
    }
    
    public static WebCustomTooltip setTooltip(final Component component,
            final String tooltip, final TooltipWay tooltipWay, final int delay) {
    ...
    public static WebCustomTooltip setTooltip(final Component component,
        ...
        return setTooltip(component,
                WebCustomTooltip.createDefaultComponent(icon, tooltip),
                tooltipWay, delay);
    }
    ...
    public static WebCustomTooltip setTooltip(final Component component,
            final JComponent tooltip, final int delay) {
    ...
    public static WebCustomTooltip addTooltip(final Component component,
            final String tooltip) {
    ...
    public static WebCustomTooltip addTooltip(final Component component,
        ...
        final boolean clear = tooltips != null && tooltips.size() > 0
                && !allowMultiplyTooltips;
        return addTooltip(component, tooltip, tooltipWay, delay, clear);
    }
    
    protected static WebCustomTooltip addTooltip(final Component component,
            final JComponent tooltip, final TooltipWay tooltipWay,
        ...
        final WebCustomTooltip customTooltip = new WebCustomTooltip(component,
                tooltip, tooltipWay, showHotkeysInTooltips);
        ...
        if (!timers.containsKey(component) || !adapters.containsKey(component)) {
            // Tooltip pop timer
            final WebTimer showTips = new WebTimer(
                    "TooltipManager.displayTimer", delay);
            ...
            final MouseAdapter mouseAdapter = new MouseAdapter() {
                ...
                public void mouseEntered(final MouseEvent e) {
                    ...
                    final Window window = SwingUtils
    ...
    public static boolean showTooltips(final Component component,
        ...
        if (webTooltips.containsKey(component) && component.isShowing()) {
            if (delayed) {
                ...
                final WebGlassPane webGlassPane = GlassPaneManager
        ...
        if (window.isShowing()) {
            for (final Component component : webTooltips.keySet()) {
                if (SwingUtils.getWindowAncestor(component) == window
                        && component.isShowing()) {
                    for (final WebCustomTooltip tooltip : webTooltips
                            .get(component)) {
    ...
    public static void installShowAllTooltipsAction(
            final Component topComponent, final HotkeyData hotkeyData) {
        HotkeyManager.registerHotkey(topComponent, hotkeyData,
                new HotkeyRunnable() {
                    @Override
    ...
    public static void removeTooltips(final Component component) {
        if (webTooltips.get(component) != null) {
            for (final WebCustomTooltip tooltip : CollectionUtils
                    .copy(webTooltips.get(component))) {
    ...
    public static void removeTooltips(final Component component,
            final WebCustomTooltip... tooltips) {
        for (final WebCustomTooltip tooltip : tooltips) {
            removeTooltip(component, tooltip);
        }
    }
    ...
    public static void removeTooltips(final Component component,
            final List<WebCustomTooltip> tooltips) {
        for (final WebCustomTooltip tooltip : tooltips) {
            removeTooltip(component, tooltip);
        }
    }
    
    public static void removeTooltip(final Component component,
    ...
    public static WebCustomTooltip showOneTimeTooltip(
            final Component component, final Point point, final String tooltip) {
        return showOneTimeTooltip(component, point, tooltip, null);
    }
    
    public static WebCustomTooltip showOneTimeTooltip(
            final Component component, final Point point, final Icon icon,
            final String tooltip) {
    ...
    public static WebCustomTooltip showOneTimeTooltip(
            ...
            final String tooltip, final TooltipWay tooltipWay) {
        final WebCustomTooltip customTooltip = new WebCustomTooltip(component,
                icon, tooltip, tooltipWay, showHotkeysInOneTimeTooltips);
        customTooltip.setDisplayLocation(point);
        return showOneTimeTooltip(customTooltip, true);
    }
    
    public static WebCustomTooltip showOneTimeTooltip(
            final Component component, final Point point,
            final JComponent tooltip) {
        return showOneTimeTooltip(component, point, tooltip, null);
    }
    ...
    public static WebCustomTooltip showOneTimeTooltip(
            ...
            final JComponent tooltip, final TooltipWay tooltipWay) {
        final WebCustomTooltip customTooltip = new WebCustomTooltip(component,
                tooltip, tooltipWay, showHotkeysInOneTimeTooltips);
        customTooltip.setDisplayLocation(point);
        return showOneTimeTooltip(customTooltip, true);
    }
    
    public static WebCustomTooltip showOneTimeTooltip(
            final WebCustomTooltip customTooltip) {
        return showOneTimeTooltip(customTooltip, true);
    }
    
    protected static WebCustomTooltip showOneTimeTooltip(
            final WebCustomTooltip customTooltip, final boolean destroyOnClose) {
        // Checking if component is properly set and showing
        if (customTooltip.getComponent() == null
                || !customTooltip.getComponent().isShowing()) {
            return null;
        }
        
        // Checking if glass pane is available
        final Window window = SwingUtils.getWindowAncestor(customTooltip
                .getComponent());
        ...
        final AWTEventListener closeListener = customTooltip
                .isDefaultCloseBehavior() ? new AWTEventListener() {
            @Override
            public void eventDispatched(final AWTEvent event) {
        ...
        customTooltip.addTooltipListener(new TooltipAdapter() {
            ...
            public void tooltipShowing() {
                if (customTooltip.isDefaultCloseBehavior()) {
                    ...
                    Toolkit.getDefaultToolkit().addAWTEventListener(
                            closeListener, AWTEvent.MOUSE_EVENT_MASK);
                }
            }
    ...
    public static void setAllowMultiplyTooltips(
            final boolean allowMultiplyTooltips) {
    ...
    public static void setShowHotkeysInTooltips(
            final boolean showHotkeysInTooltips) {
    ...
    public static void setShowHotkeysInOneTimeTooltips(
            final boolean showHotkeysInOneTimeTooltips) {
