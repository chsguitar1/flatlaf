...
public final class WebCustomTooltipStyle {
    ...
    /**
     * Default tooltip display way. If set to null - best display way will be
     * calculated each time tooltip shown.
     */
    public static TooltipWay displayWay = null;
    
    /**
     * Whether to show component hotkeys information at the right side of the
     * tooltip or not. Only non-hidden hotkeys information will be displayed.
     */
    public static boolean showHotkey = true;
    
    /**
     * Hotkey location inside the tooltip. It might have either
     * SwingConstants.LEFT, RIGHT, LEADING or TRAILING value.
     */
    public static int hotkeyLocation = SwingConstants.TRAILING;
    
    /**
     * Whether tooltip should use default close behavior () or allow user to
     * define his own close behavior. Default behavior is when tooltip closes
     * when cursor leave component area, or when any mouse/key press occurs.
     */
    ...
    /**
     * Additional left and right sides content spacing. This is basically used
     * to improve text readability in tooltips.
     */
    public static int leftRightSpacing = 0;
    
    /**
     * Minimal spacing between window edge and tooltip. Used to avoid tooltips
     * falling behind the window edge when shown close to it.
     */
    ...
    /**
     * Tooltip top background color. When set to null background won't be drawn
     * at all.
     */
    public static Color topBgColor = Color.BLACK;
    
    /**
     * Tooltip bottom background color. When set to null background will be
     * filled with topBgColor.
     */
