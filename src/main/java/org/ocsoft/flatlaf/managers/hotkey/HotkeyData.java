...
public class HotkeyData implements Serializable, Cloneable {
     ...
     *            key code required for the hotkey activation
     */
    public HotkeyData(final boolean isCtrl, final boolean isAlt,
     ...
     *
     * @param alt
     *            whether hotkey activation should require ALT modifier or not
     */
     ...
     *
     * @return true if hotkey activation requires SHIFT modifier, false
     *         otherwise
     */
     ...
     *
     * @param shift
     *            whether hotkey activation should require SHIFT modifier or not
     */
     ...
     * @param event
     *            processed key event
     * @return true if hotkey controls are triggered by the key event, false
     *         otherwise
     */
    ...
    public int getModifiers() {
        return (isCtrl ? SwingUtils.getSystemShortcutModifier() : 0)
                | (isAlt ? KeyEvent.ALT_MASK : 0)
                | (isShift ? KeyEvent.SHIFT_MASK : 0);
    }
    ...
    public boolean equals(final Object obj) {
        return obj != null && obj instanceof HotkeyData
