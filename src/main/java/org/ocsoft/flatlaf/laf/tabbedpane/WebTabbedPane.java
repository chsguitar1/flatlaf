...
public class WebTabbedPane extends JTabbedPane implements ShapeProvider,
        LanguageMethods, SettingsMethods, FontMethods<WebTabbedPane>,
    ...
    public WebTabbedPane(final int tabPlacement, final int tabLayoutPolicy,
            final TabbedPaneStyle style) {
        super(tabPlacement, tabLayoutPolicy);
        setTabbedPaneStyle(style);
    }
    
    /**
     * Returns tab index for the specified location or -1 if there is no tab
     * there.
     *
     * @param point
     *            location
     * @return tab index for the specified location or -1 if there is no tab
     *         there
     */
    ...
    /**
     * Returns tab bounds for the specified location or null if there is no tab
     * there.
     *
     * @param point
     *            location
     * @return tab bounds for the specified location or null if there is no tab
     *         there
     */
    ...
    public void updateUI() {
        if (getUI() == null || !(getUI() instanceof WebTabbedPaneUI)) {
            try {
                setUI((WebTabbedPaneUI) ReflectUtils
                        .createInstance(FlatLafSettings.tabbedPaneUI));
     ...
     */
    @Override
    public WebTabbedPane setFontSizeAndStyle(final int fontSize,
