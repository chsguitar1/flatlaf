...
public class WebComboBox extends JComboBox implements ShapeProvider,
        EventMethods, ToolTipMethods, SettingsMethods,
    ...
    /**
     * Returns selected value index. This method is overriden by WebComboBox to
     * fix issue with "null" value from the model being ignored if selected. By
     * default (in JComboBox) this method will not return index of "null" value
     * in the model if it is selected.
     *
     ...
     */
    @Override
    public WebComboBox setFontSizeAndStyle(final int fontSize,
