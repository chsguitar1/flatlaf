...
import org.ocsoft.flatlaf.extended.filechooser.WebFileTable;
...
import org.ocsoft.flatlaf.extended.list.FileElement;
import org.ocsoft.flatlaf.extended.list.FileListViewType;
...
import org.ocsoft.flatlaf.laf.combobox.WebComboBoxStyle;
import org.ocsoft.flatlaf.laf.label.WebLabel;
import org.ocsoft.flatlaf.laf.list.WebList;
import org.ocsoft.flatlaf.laf.list.editor.ListEditAdapter;
...
import org.ocsoft.flatlaf.laf.scroll.WebScrollBar;
...
/**
 * File chooser panel component. Basically used to provide WebFileChooserUI with
...
public class WebFileChooserPanel extends WebPanel {
    /**
     * todo 1. When setting "show hidden files" to false - move out from hidden
     * directories todo 2. Proper hotkeys usage within window todo 3. Context
     * menu for file selection components
     */
    
    /**
     * Used icons.
     */
    public static final ImageIcon BACKWARD_ICON = new ImageIcon(
            WebFileChooserPanel.class.getResource("icons/backward.png"));
    public static final ImageIcon FORWARD_ICON = new ImageIcon(
            WebFileChooserPanel.class.getResource("icons/forward.png"));
    public static final ImageIcon HISTORY_ICON = new ImageIcon(
            WebFileChooserPanel.class.getResource("icons/history.png"));
    public static final ImageIcon FOLDER_UP_ICON = new ImageIcon(
            WebFileChooserPanel.class.getResource("icons/folder_up.png"));
    public static final ImageIcon FOLDER_HOME_ICON = new ImageIcon(
            WebFileChooserPanel.class.getResource("icons/folder_home.png"));
    public static final ImageIcon FOLDER_NEW_ICON = new ImageIcon(
            WebFileChooserPanel.class.getResource("icons/folder_new.png"));
    public static final ImageIcon REFRESH_ICON = new ImageIcon(
            WebFileChooserPanel.class.getResource("icons/refresh.png"));
    public static final ImageIcon REMOVE_ICON = new ImageIcon(
            WebFileChooserPanel.class.getResource("icons/remove.png"));
    public static final ImageIcon VIEW_ICON = new ImageIcon(
            WebFileChooserPanel.class.getResource("icons/view.png"));
    public static final ImageIcon VIEW_ICONS_ICON = new ImageIcon(
            WebFileChooserPanel.class.getResource("icons/icons.png"));
    public static final ImageIcon VIEW_TILES_ICON = new ImageIcon(
            WebFileChooserPanel.class.getResource("icons/tiles.png"));
    public static final ImageIcon VIEW_TABLE_ICON = new ImageIcon(
            WebFileChooserPanel.class.getResource("icons/table.png"));
    public static final ImageIcon SETTINGS_ICON = new ImageIcon(
            WebFileChooserPanel.class.getResource("icons/settings.png"));
    public static final ImageIcon APPROVE_ICON = new ImageIcon(
            WebFileChooserPanel.class.getResource("icons/approve.png"));
    public static final ImageIcon CANCEL_ICON = new ImageIcon(
            WebFileChooserPanel.class.getResource("icons/cancel.png"));
    ...
    /**
     * Custom approve button listener. By default panel does nothing on approve
     * button press.
     */
    protected ActionListener approveListener;
    
    /**
     * Custom cancel button listener. By default panel does nothing on cancel
     * button press.
     */
    ...
    /**
     * Editing state provider. todo This is a temporary workaround for
     * HotkeysManager actions
     */
    protected DataProvider<Boolean> hotkeysAllowed = new DataProvider<Boolean>() {
        ...
        public Boolean provide() {
            return !fileTree.isEditing() && !fileList.isEditing()
                    && !fileTable.isEditing() && !pathField.isEditing()
     ...
     *            whether to add control buttons or not
     */
     ...
     */
    public WebFileChooserPanel(final FileChooserType chooserType,
            final boolean showControlButtons) {
        super();
    ...
    protected Component createNorthContent() {
        ...
        toolBar.addAncestorListener(new AncestorAdapter() {
            ...
            private void updateToolbarStyle() {
                toolBar.setUndecorated(SwingUtils
                        .isLafDecorated(WebFileChooserPanel.this));
            }
        });
        ...
        backward.addHotkey(WebFileChooserPanel.this, Hotkey.ALT_LEFT)
        ...
        forward.addHotkey(WebFileChooserPanel.this, Hotkey.ALT_RIGHT)
        ...
        history.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(final ActionEvent e) {
                ...
                historyList.setVisibleRowCount(Math.min(10,
                ...
                historyList.setCellRenderer(new WebComboBoxCellRenderer() {
                    ...
                    public Component getListCellRendererComponent(
                        ...
                        if (file == null) {
                            ...
                            renderer.setText(LanguageManager
                                    .get("weblaf.filechooser.root"));
                        } else {
                            renderer.setIcon(FileUtils.getFileIcon(file));
                            renderer.setText(TextUtils.shortenText(
                                    FileUtils.getDisplayFileName(file), 40,
                                    true));
                        }
        ...
        folderUp.addHotkey(WebFileChooserPanel.this, Hotkey.ALT_UP)
                .setHotkeyDisplayWay(TooltipWay.down);
        ...
        folderHome.addHotkey(WebFileChooserPanel.this, Hotkey.ALT_HOME)
                .setHotkeyDisplayWay(TooltipWay.down);
        ...
        folderHome.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(final ActionEvent e) {
                if (hotkeysAllowed.provide()) {
                    updateCurrentFolder(FileUtils.getUserHome(),
                            UpdateSource.toolbar);
                }
            }
        });
        ...
        refresh.addHotkey(WebFileChooserPanel.this, Hotkey.F5)
                .setHotkeyDisplayWay(TooltipWay.down);
        ...
        folderNew.addHotkey(WebFileChooserPanel.this, Hotkey.CTRL_N)
                .setHotkeyDisplayWay(TooltipWay.down);
        ...
        folderNew.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(final ActionEvent e) {
                if (hotkeysAllowed.provide() && currentFolder != null) {
                    final String defaultName = LanguageManager
                            .get("weblaf.filechooser.newfolder.name");
                    final String freeName = FileUtils.getAvailableName(
                            currentFolder, defaultName);
                    final File file = new File(currentFolder, freeName);
                    if (file.mkdir()) {
                        // Update view
                        // This action can be optimized, but that will make a
                        // lot of additional actions and most likely cause some
                        // troubles
                        reloadCurrentFolder();
                        ...
                        final String message = LanguageManager
                                .get("weblaf.filechooser.newfolder.error.text");
                        final String title = LanguageManager
                                .get("weblaf.filechooser.newfolder.error.title");
                        WebOptionPane.showMessageDialog(
                                WebFileChooserPanel.this, message, title,
        ...
        remove.addHotkey(WebFileChooserPanel.this, Hotkey.DELETE)
                .setHotkeyDisplayWay(TooltipWay.down);
        ...
        view.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(final ActionEvent e) {
                ...
                final WebRadioButtonMenuItem icons = new WebRadioButtonMenuItem(
                        VIEW_ICONS_ICON);
                icons.setLanguage("weblaf.filechooser.view.icons");
                icons.setSelected(getViewType().equals(
                        FileChooserViewType.icons));
                ...
                final WebRadioButtonMenuItem tiles = new WebRadioButtonMenuItem(
                        VIEW_TILES_ICON);
                tiles.setLanguage("weblaf.filechooser.view.tiles");
                tiles.setSelected(getViewType().equals(
                        FileChooserViewType.tiles));
                ...
                final WebRadioButtonMenuItem table = new WebRadioButtonMenuItem(
                        VIEW_TABLE_ICON);
                table.setLanguage("weblaf.filechooser.view.table");
                table.setSelected(getViewType().equals(
                        FileChooserViewType.table));
    ...
    protected void updateHistoryState(final int historyIndex) {
        if (historyIndex >= 0 && historyIndex < navigationHistory.size()) {
            ...
            updateCurrentFolder(navigationHistory.get(historyIndex),
        ...
        fileTreeListener = new TreeSelectionListener() {
            ...
            public void valueChanged(final TreeSelectionEvent e) {
                if (fileTree.getSelectionCount() > 0) {
                    updateCurrentFolder(fileTree.getSelectedFile(),
                            UpdateSource.tree);
                }
            }
        };
    ...
    protected void createFileList() {
        ...
        fileList.setTransferHandler(new FilesLocateDropHandler(
                UpdateSource.list));
        
        fileList.getInputMap().put(
                KeyStroke.getKeyStroke(KeyEvent.VK_ENTER, 0), "openFolder");
            ...
            public void mouseClicked(final MouseEvent e) {
                if (SwingUtilities.isLeftMouseButton(e)
                    ...
                    if (file.isDirectory()) {
                        ...
                        fireApproveAction(new ActionEvent(fileList, e.getID(),
                                "Files selected", e.getWhen(), e.getModifiers()));
                    }
                }
            }
        });
        ...
        fileList.addListEditListener(new ListEditAdapter() {
            @Override
            public void editFinished(final int index, final Object oldValue,
                    final Object newValue) {
                // Saving for futher selection
                final File file = ((FileElement) newValue).getFile();
                
                // Updating current view
                // This action can be optimized, but that will make a lot of
                // additional actions and most likely cause some troubles
                reloadCurrentFolder();
        ...
        fileListScroll
                .setVerticalScrollBarPolicy(WebScrollPane.VERTICAL_SCROLLBAR_ALWAYS);
    }
    ...
    protected void createFileTable() {
        ...
        fileTable.setTransferHandler(new FilesLocateDropHandler(
                UpdateSource.table));
        
        fileTable.getInputMap().put(
                KeyStroke.getKeyStroke(KeyEvent.VK_ENTER, 0), "openFolder");
            ...
            public void mouseClicked(final MouseEvent e) {
                if (SwingUtilities.isLeftMouseButton(e)
                    ...
                    if (file.isDirectory()) {
                        ...
                        fireApproveAction(new ActionEvent(fileTable, e.getID(),
                                "Files selected", e.getWhen(), e.getModifiers()));
                    }
                }
            }
        ...
        fileTable.getDefaultEditor(File.class).addCellEditorListener(
    ...
    protected Component createSouthContent() {
        ...
        selectedFilesPanel = new WebPanel(
                chooserType == FileChooserType.save ? selectedFilesTextField
        ...
        fileFilters.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(final ActionEvent e) {
                setActiveFileFilter(
                        (AbstractFileFilter) fileFilters.getSelectedItem(),
                        false);
            }
        });
        
        approveButton = new WebButton("", APPROVE_ICON);
        // approveButton.addHotkey ( WebFileChooserPanel.this, Hotkey.CTRL_ENTER
        // ).setHotkeyDisplayWay ( TooltipWay.up );
        approveButton
        ...
        // cancelButton.addHotkey ( WebFileChooserPanel.this, Hotkey.ESCAPE
        // ).setHotkeyDisplayWay ( TooltipWay.up );
        cancelButton
                .setRolloverShine(FlatLafStyleConstants.highlightControlButtons);
    ...
    public void setViewType(final FileChooserViewType viewType) {
        ...
        final boolean viewChanged = viewType.getComponentIndex() != this.viewType
                .getComponentIndex();
     ...
     *
     * @param file
     *            folder to be opened or file to be displayed
     * @param updateSource
     *            update call source
     */
    protected void updateCurrentFolder(File file,
    ...
    protected void updateControlsState() {
        ...
        folderUp.setEnabled(FlatLafSystemUtils.isWindows() ? currentFolder != null
                : currentFolder != null
    ...
    public List<File> getSelectedFiles() {
        if (chooserType == FileChooserType.save) {
            ...
            return Arrays.asList(new File(currentFolder, selectedFilesTextField
                    .getText()));
        } else {
     ...
     */
    protected List<File> getFilteredSelectedFiles(
    ...
    protected void updateSelectedFilesFieldImpl(final Collection<File> selected) {
        ...
        if (chooserType == FileChooserType.save) {
            if (files.size() > 0) {
                // Accept only file as selection, otherwise leave old file
                // selected
    ...
    private String getFilesView(final List<File> files) {
        return files.size() > 1 ? getMultiFilesView(files)
                : files.size() == 1 ? getSingleFileView(files.get(0)) : "";
    }
    ...
    protected void updateApproveButtonState(List<File> files) {
        if (chooserType == FileChooserType.save) {
            ...
            approveButton.setEnabled(!selectedFilesTextField.getText().trim()
                    .equals(""));
        } else {
    ...
    protected void updateSelectedFilesFieldPanel() {
        ...
        selectedFilesPanel
                .add(chooserType == FileChooserType.save ? selectedFilesTextField
                        : selectedFilesViewField);
    ...
    protected void updateFiltersComboBox() {
        fileFilters.setModel(new DefaultComboBoxModel(availableFilters
                .toArray()));
    }
    
    /**
     * Sets currently active file filter. Notice that this filter must be in the
     * filters list to be activated.
     *
     * @param fileFilter
     *            file filter to make active
     */
     ...
     *            file filter to make active
     * @param select
     *            whether to select active file filter in combobox or not
     */
    protected void setActiveFileFilter(AbstractFileFilter fileFilter,
            final boolean select) {
        // Simply take the first available filter if the specified one is not
        // available
        ...
        // Select in combobox (this won't cause action event to fire, so its
        // fine)
        if (select) {
    ...
    protected void updateFileComponentFilters() {
        ...
        fileTable
                .setFileFilter(applyHiddenFilesFilter(applyOrDirectoriesFilter(fileFilter)));
    }
    ...
    protected void updateDirectoryComponentFilters() {
        pathField
                .setFileFilter(applyHiddenFilesFilter(FlatLafFileFilters.DIRECTORIES_FILTER));
     ...
     */
    protected GroupedFileFilter applyOrDirectoriesFilter(
            final AbstractFileFilter fileFilter) {
        return new GroupedFileFilter(FilterGroupType.OR, fileFilter,
                FlatLafFileFilters.DIRECTORIES_FILTER);
    }
     ...
     * @return new file filter with additional condition
     */
    protected GroupedFileFilter applyHiddenFilesFilter(
            final AbstractFileFilter fileFilter) {
        return new GroupedFileFilter(FilterGroupType.AND, fileFilter,
                hiddenFilesFilter);
    }
    
    /**
     * Reloads files from currently opened folder into all available view
     * components.
     */
    ...
    public void deleteSelectedFiles() {
        ...
        all.add(new WebLabel(LanguageManager
                .get("weblaf.filechooser.delete.confirm.text")),
                BorderLayout.NORTH);
        
        final WebPanel deleteFilesPanel = new WebPanel(new VerticalFlowLayout(
                VerticalFlowLayout.TOP, 0, 5, true, false));
        deleteFilesPanel.setMargin(3);
        deleteFilesPanel.setBackground(Color.WHITE);
        for (final File file : files) {
            deleteFilesPanel.add(new WebLabel(file.getName(), FileUtils
                    .getFileIcon(file), WebLabel.LEFT));
        }
        ...
        final String title = LanguageManager
                .get("weblaf.filechooser.delete.confirm.title");
        final int confirm = WebOptionPane.showConfirmDialog(
                WebFileChooserPanel.this, all, title,
    ...
    /**
     * Sets available file filters. The first one specified will be the default
    ...
    public void setFileFilters(
            final javax.swing.filechooser.FileFilter[] fileFilters) {
        setFileFilters(0, fileFilters);
    }
     ...
     *            available file filters
     */
    public void setFileFilters(final int index,
            final javax.swing.filechooser.FileFilter[] fileFilters) {
        availableFilters = new ArrayList<AbstractFileFilter>(fileFilters.length);
     ...
     */
    public void setFileFilters(final int index,
            final AbstractFileFilter[] fileFilters) {
     ...
     */
    public void setFileFilters(final int index,
            final List<AbstractFileFilter> fileFilters) {
    ...
    protected void updateControls() {
        ...
        controlsPanel.add(showControlButtons ? new GroupPanel(4, fileFilters,
                approveButton, cancelButton) : fileFilters);
    }
    ...
    /**
     * Sets approve button text. You can specify null to reset text to default
     * value.
     *
     * @param text
     *            approve button text
    ...
    public void setApproveButtonText(final String text) {
        if (text == null) {
            setApproveButtonText(chooserType == FileChooserType.save ? FileApproveText.save
                    : chooserType == FileChooserType.open ? FileApproveText.open
                            : FileApproveText.choose);
        } else {
     ...
     *
     * @param newDirectory
     *            newly displayed directory
     */
    protected void fireDirectoryChanged(final File newDirectory) {
        for (final FileChooserListener listener : CollectionUtils
                .copy(chooserListeners)) {
    ...
    protected void updateSelectionMode() {
        final boolean ms = multiSelectionEnabled
                && chooserType != FileChooserType.save;
        
        final int mode = ms ? ListSelectionModel.MULTIPLE_INTERVAL_SELECTION
    ...
    /**
     * FileDragAndDropHandler extension to provide drop-to-find-file
     * functionality.
     */
