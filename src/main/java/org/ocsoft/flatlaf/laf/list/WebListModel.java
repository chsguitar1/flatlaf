 ...
 * elements add/remove methods and works with typed elements.
 *
 * @author Mikle Garin
 */
...
public class WebListModel<T> extends AbstractListModel {
     ...
     * preferred method to use is {@code get(int)}, which implements the
     ...
     *             if the {@code index} is negative or greater than the current
     *             size of this list
     * @see #get(int)
     */
    @Override
     ...
     *         after {@code index}; returns {@code -1} if the {@code elem} is
     ...
     *         at position less than {@code index}; returns {@code -1} if the
     *         object is not found
     ...
     * {@code ArrayIndexOutOfBoundsException} if the index is negative or not
     * less than the size of the list. <blockquote> <b>Note:</b> Although this
     * method is not deprecated, the preferred method to use is {@code get(int)}
     * , which implements the {@code List} interface defined in the 1.2
     ...
     * {@code NoSuchElementException} if this vector has no components.
     *
     ...
     * <p/>
     * Throws an {@code ArrayIndexOutOfBoundsException} if the index is invalid.
     * <blockquote> <b>Note:</b> Although this method is not deprecated, the
     * preferred method to use is {@code set(int, Object)}, which implements the
     * {@code List} interface defined in the 1.2 Collections framework.
     * </blockquote>
     *
     * @param obj
     ...
     * Throws an {@code ArrayIndexOutOfBoundsException} if the index is invalid.
     * <blockquote> <b>Note:</b> Although this method is not deprecated, the
     * preferred method to use is {@code remove(int)}, which implements the
     * {@code List} interface defined in the 1.2 Collections framework.
     * </blockquote>
     *
     * @param index
     ...
     * Throws an {@code ArrayIndexOutOfBoundsException} if the index is invalid.
     * <blockquote> <b>Note:</b> Although this method is not deprecated, the
     * preferred method to use is {@code add(int, Object)}, which implements the
     * {@code List} interface defined in the 1.2 Collections framework.
     * </blockquote>
     *
     * @param obj
     ...
     * <blockquote> <b>Note:</b> Although this method is not deprecated, the
     * preferred method to use is {@code clear}, which implements the
     * {@code List} interface defined in the 1.2 Collections framework.
     * </blockquote>
     *
     * @see #clear()
    ...
    /**
     * Removes all elements from this list which has index lower than the
     * specified one.
     *
     * @param index
     *            index to process
    ...
    /**
     * Removes all elements from this list which has index larger than the
     * specified one.
     *
     * @param index
     *            index to process
     ...
     * <p/>
     * Throws an {@code ArrayIndexOutOfBoundsException} if the index is out of
     * range ({@code index &lt; 0 || index &gt;=
     * size()}).
     *
     * @param index
     ...
     * <p/>
     * Throws an {@code ArrayIndexOutOfBoundsException} if the index was
     * invalid. Throws an {@code IllegalArgumentException} if
