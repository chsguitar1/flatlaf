...
public class FlatLafInitializer {
    ...
    static String[] createSystemColorDefaults (UIDefaults table ) {
        ...
        String textColor = ColorUtils.getHexColor ( FlatLafStyleConstants.textColor );
        String textHighlightColor = ColorUtils.getHexColor ( FlatLafStyleConstants.textSelectionColor );
        String inactiveTextColor = ColorUtils.getHexColor ( FlatLafStyleConstants.disabledTextColor );
    ...
    static void initializeFonts (UIDefaults table) {
        initializeFont ( table, "Button.font", 
                FlatLafSettings.buttonFont, FontGroup.CONTROL );
        ...
        initializeFont ( table, "CheckBox.font", 
                FlatLafSettings.checkBoxFont, FontGroup.CONTROL );
        initializeFont ( table, "ColorChooser.font", 
                FlatLafSettings.colorChooserFont, FontGroup.CONTROL );
        initializeFont ( table, "ComboBox.font", 
                FlatLafSettings.comboBoxFont, FontGroup.TEXT );
        initializeFont ( table, "InternalFrame.titleFont", 
                FlatLafSettings.internalFrameFont, FontGroup.TITLE );
        initializeFont ( table, "Label.font", 
                FlatLafSettings.labelFont, FontGroup.CONTROL );
        initializeFont ( table, "List.font", 
                FlatLafSettings.listFont, FontGroup.CONTROL );
        initializeFont ( table, "MenuBar.font", 
                FlatLafSettings.menuBarFont, FontGroup.MENU );
        initializeFont ( table, "MenuItem.font", 
                FlatLafSettings.menuItemFont, FontGroup.MENU );
        ...
        initializeFont ( table, "RadioButtonMenuItem.acceleratorFont", 
                FlatLafSettings.radioButtonMenuItemAcceleratorFont, FontGroup.ACCELERATOR );
        ...
        initializeFont ( table, "CheckBoxMenuItem.acceleratorFont", 
                FlatLafSettings.checkBoxMenuItemAcceleratorFont, FontGroup.ACCELERATOR );
        initializeFont ( table, "Menu.font", 
                FlatLafSettings.menuFont, FontGroup.MENU );
        initializeFont ( table, "Menu.acceleratorFont", 
                FlatLafSettings.menuAcceleratorFont, FontGroup.ACCELERATOR );
        initializeFont ( table, "PopupMenu.font", 
                FlatLafSettings.popupMenuFont, FontGroup.MENU );
        initializeFont ( table, "OptionPane.font", 
                FlatLafSettings.optionPaneFont, FontGroup.ALERT );
        initializeFont ( table, "Panel.font", 
                FlatLafSettings.panelFont, FontGroup.CONTROL );
        ...
        initializeFont ( table, "Viewport.font", 
                FlatLafSettings.viewportFont, FontGroup.CONTROL );
        initializeFont ( table, "Slider.font", 
                FlatLafSettings.sliderFont, FontGroup.CONTROL );
        initializeFont ( table, "Spinner.font", 
                FlatLafSettings.spinnerFont, FontGroup.TEXT );
        initializeFont ( table, "TabbedPane.font", 
                FlatLafSettings.tabbedPaneFont, FontGroup.CONTROL );
        initializeFont ( table, "Table.font", 
                FlatLafSettings.tableFont, FontGroup.CONTROL );
        initializeFont ( table, "TableHeader.font", 
                FlatLafSettings.tableHeaderFont, FontGroup.CONTROL );
        initializeFont ( table, "TextField.font", 
                FlatLafSettings.textFieldFont, FontGroup.TEXT );
        ...
        initializeFont ( table, "TextArea.font", 
                FlatLafSettings.textAreaFont, FontGroup.TEXT );
        initializeFont ( table, "TextPane.font", 
                FlatLafSettings.textPaneFont, FontGroup.TEXT );
        ...
        initializeFont ( table, "ToolBar.font", 
                FlatLafSettings.toolBarFont, FontGroup.CONTROL );
        initializeFont ( table, "ToolTip.font", 
                FlatLafSettings.toolTipFont, FontGroup.TOOLTIP );
        initializeFont ( table, "Tree.font", 
                FlatLafSettings.treeFont, FontGroup.CONTROL );
    }
     ...
     */
    private static void initializeFont(UIDefaults table, String key, Font font, FontGroup group) {
    ...
    public static void initClassDefaults (UIDefaults table ) {
        ...
        table.put ( "RadioButtonMenuItemUI", FlatLafSettings.radioButtonMenuItemUI );
