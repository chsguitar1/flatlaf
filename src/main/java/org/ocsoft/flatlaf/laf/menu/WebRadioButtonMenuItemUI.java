...
public class WebRadioButtonMenuItemUI extends WebMenuItemUI {
     ...
     * Used icons.
     */
    protected static final ImageIcon radioIcon = new ImageIcon(
            WebRadioButtonMenuItemUI.class.getResource("icons/radio.png"));
    protected static final ImageIcon radioCheckIcon = new ImageIcon(
            WebRadioButtonMenuItemUI.class.getResource("icons/radioCheck.png"));
    ...
    /**
     * Returns an instance of the WebRadioButtonMenuItemUI for the specified
    ...
    public Paint getNorthCornerFill() {
        final boolean selected = menuItem.isEnabled()
                && menuItem.getModel().isArmed();
        return !selected && menuItem.isSelected() ? checkColor : super
                .getNorthCornerFill();
    }
    ...
    protected void paintIcon(final Graphics2D g2d, final JMenuItem menuItem,
        ...
        if (menuItem.getIcon() == null) {
            ...
            g2d.drawImage(menuItem.isSelected() ? radioCheckIcon.getImage()
                    : radioIcon.getImage(), ix, iy, null);
        }
    }
}