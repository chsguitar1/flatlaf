...
/**
 * This JRadioButtonMenuItem extension class provides a direct access to
 * WebRadioButtonMenuItemUI methods.
 *
 * @author Mikle Garin
 */

public class WebRadioButtonMenuItem extends JRadioButtonMenuItem implements
        LanguageMethods, SettingsMethods, FontMethods<WebRadioButtonMenuItem> {
    /**
     ...
     *            menu item icon
     * @param selected
     *            whether this radiobutton item is selected or not
     */
    ...
    public void updateUI() {
        if (getUI() == null || !(getUI() instanceof WebRadioButtonMenuItemUI)) {
            try {
                setUI((WebRadioButtonMenuItemUI) ReflectUtils
                        .createInstance(FlatLafSettings.radioButtonMenuItemUI));
     ...
     */
    @Override
    public WebRadioButtonMenuItem setFontStyle(final boolean bold,
     ...
     */
    @Override
    public WebRadioButtonMenuItem setFontSizeAndStyle(final int fontSize,
