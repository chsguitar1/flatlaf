...
public interface PopupMenuPainter<E extends JPopupMenu> extends Painter<E>,
        SpecificPainter {
    /**
     * Sets whether popup menu is transparent or not. This mark is updated only
     * once per component as it is initialized on UI initialization only.
     *
     * @param transparent
     *            whether popup menu is transparent or not
     */
    ...
    /**
     * Sets whether should fix initial popup menu location or not. If set to
     * true popup menu will try to use best possible location to show up.
     * <p/>
    ...
    /**
     * Sets preferred popup menu display way. This value is updated right before
     * preparePopupMenu method call.
     *
     * @param way
     *            preferred popup menu display way
     */
    public void setPopupMenuWay(PopupMenuWay way);
    
    /**
     * Sets popup menu type. This value is updated right before popup menu
     * window becomes visible. You can use it to draw different popup menu
     * decoration for each popup menu type.
     *
     * @param type
     *            popup menu type
     */
     ...
     *
     * @param popupMenu
     *            JPopupMenu to prepare for display
     * @param x
     *            screen x location actual popup is to be shown at
     * @param y
