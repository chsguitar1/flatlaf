...
public class WebCheckBoxMenuItemUI extends WebMenuItemUI {
     ...
     * Used icons.
     */
    protected static final ImageIcon boxIcon = new ImageIcon(
            WebCheckBoxMenuItemUI.class.getResource("icons/box.png"));
    protected static final ImageIcon boxCheckIcon = new ImageIcon(
            WebCheckBoxMenuItemUI.class.getResource("icons/boxCheck.png"));
    ...
    /**
     * Returns an instance of the WebCheckBoxMenuItemUI for the specified
    ...
    protected void paintIcon(final Graphics2D g2d, final JMenuItem menuItem,
        ...
        if (menuItem.getIcon() == null) {
            ...
            g2d.drawImage(menuItem.isSelected() ? boxCheckIcon.getImage()
                    : boxIcon.getImage(), ix, iy, null);
        }
    }
}