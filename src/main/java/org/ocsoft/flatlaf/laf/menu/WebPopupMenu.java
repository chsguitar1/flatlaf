 ...
 * methods. It also has a few additional methods to simplify popup window
 * positioning.
 *
 * @author Mikle Garin
 */

public class WebPopupMenu extends JPopupMenu implements Styleable,
        ShapeProvider, SizeMethods<WebPopupMenu>, LanguageContainerMethods {
    /**
     ...
     * side. This method takes into account component orientation.
     *
     * @param invoker
     *            invoker component
     ...
     * side. This method also takes into account component orientation.
     *
     * @param invoker
     *            invoker component
     * @return this popup menu
     ...
     *
     * @param top
     *            top popup menu content margin
     * @param left
     *            left popup menu content margin
     * @param bottom
     *            bottom popup menu content margin
     * @param right
     *            right popup menu content margin
     * @return this popup menu
     */
    public WebPopupMenu setMargin(final int top, final int left,
    ...
    public void setCornerAlignment(final int cornerAlignment) {
        StyleManager.setCustomPainterProperty(this, "cornerAlignment",
                cornerAlignment);
    }
    ...
    public void updateUI() {
        if (getUI() == null || !(getUI() instanceof WebPopupMenuUI)) {
            try {
                setUI((WebPopupMenuUI) ReflectUtils
                        .createInstance(FlatLafSettings.popupMenuUI));
