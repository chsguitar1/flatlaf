...
public class WebMenu extends JMenu implements LanguageMethods,
        FontMethods<WebMenu> {
    /**
     * Constructs new menu.
     */
    ...
    public void updateUI() {
        if (getUI() == null || !(getUI() instanceof WebMenuUI)) {
            try {
                setUI((WebMenuUI) ReflectUtils
                        .createInstance(FlatLafSettings.menuUI));
     ...
     */
    @Override
    public WebMenu setFontSizeAndStyle(final int fontSize, final boolean bold,
