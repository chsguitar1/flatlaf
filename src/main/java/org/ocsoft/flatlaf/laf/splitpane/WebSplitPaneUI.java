...
public class WebSplitPaneUI extends BasicSplitPaneUI implements BorderMethods {
    ...
    public void updateBorder() {
        if (splitPane != null) {
            ...
            // Actual margin
            final boolean ltr = splitPane.getComponentOrientation()
                    .isLeftToRight();
    ...
    public BasicSplitPaneDivider createDefaultDivider() {
        return new BasicSplitPaneDivider(this) {
            protected final Border border = BorderFactory.createEmptyBorder(0,
                    0, 0, 0);
            
            protected final Color color = new Color(158, 158, 158);
            protected final Color[] gradient = new Color[] {
                    FlatLafStyleConstants.transparent, color, color,
            ...
            protected JButton createLeftOneTouchButton() {
                ...
                iconWebButton.setPreferredSize(hor ? new Dimension(6, 7)
                        : new Dimension(7, 6));
            ...
            public void paint(final Graphics g) {
                ...
                if (orientation == JSplitPane.HORIZONTAL_SPLIT) {
                    ...
                    if (drawDividerBorder) {
                        ...
                        g2d.drawLine(getWidth() - 1, 0, getWidth() - 1,
                                getHeight() - 1);
                    }
                } else {
                    ...
                    if (drawDividerBorder) {
                        ...
                        g2d.drawLine(0, getHeight() - 1, getWidth() - 1,
                                getHeight() - 1);
                    }
                }
