...
/**
 * Special class that represents checkbox icon. It can be used to render
...
public abstract class CheckIcon {
     ...
     *
     * @param c
     *            component to paint check icon onto
     * @param g2d
     *            graphics context
     * @param x
     *            icon X coordinate
     ...
     *            icon height
     */
    public abstract void paintIcon(Component c, Graphics2D g2d, int x, int y,
            int w, int h);
}