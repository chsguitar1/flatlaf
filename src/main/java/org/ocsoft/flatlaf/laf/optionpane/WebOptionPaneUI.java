...
public class WebOptionPaneUI extends BasicOptionPaneUI {
    public static final ImageIcon INFORMATION_ICON = new ImageIcon(
            WebOptionPaneUI.class.getResource("icons/information.png"));
    public static final ImageIcon WARNING_ICON = new ImageIcon(
            WebOptionPaneUI.class.getResource("icons/warning.png"));
    public static final ImageIcon ERROR_ICON = new ImageIcon(
            WebOptionPaneUI.class.getResource("icons/error.png"));
    ...
    protected void addButtonComponents(final Container container,
            final Object[] buttons, final int initialIndex) {
        ...
        if (buttons != null && buttons.length > 0) {
            ...
            for (int counter = 0; counter < numButtons; counter++) {
                ...
                if (button instanceof Component) {
                    ...
                    aButton.setMultiClickThreshhold(UIManager
                            .getInt("OptionPane.buttonClickThreshhold"));
                        ...
                        defaultB.addHierarchyListener(new HierarchyListener() {
                            ...
                            public void hierarchyChanged(final HierarchyEvent e) {
                                if ((e.getChangeFlags() & HierarchyEvent.PARENT_CHANGED) != 0) {
                                    final JButton defaultButton = (JButton) e
                                            .getComponent();
                                    final JRootPane root = SwingUtilities
        ...
        if (optionPane != null) {
            ...
            if (suppliedOptions == null) {
                ...
                if (type == JOptionPane.YES_NO_OPTION) {
                    ...
                    defaultOptions[0]
                            .setShineColor(FlatLafStyleConstants.greenHighlight);
                    defaultOptions[0].setLanguage("weblaf.optionpane.yes");
                    
                    defaultOptions[1] = new WebButton("");
                    defaultOptions[1]
                            .setShineColor(FlatLafStyleConstants.redHighlight);
                    ...
                    defaultOptions[2]
                            .setShineColor(FlatLafStyleConstants.yellowHighlight);
