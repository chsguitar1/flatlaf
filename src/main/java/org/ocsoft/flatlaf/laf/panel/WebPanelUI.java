...
public class WebPanelUI extends BasicPanelUI implements Styleable,
        ShapeProvider, BorderMethods, PartialDecoration {
    /**
     * Style settings.
     */
    ...
    /**
     * Returns an instance of the WebPanelUI for the specified component. This
    ...
    public Shape provideShape() {
        if (painter != null && painter instanceof PainterShapeProvider) {
            return ((PainterShapeProvider) painter).provideShape(panel,
                    SwingUtils.size(panel));
        } else {
     ...
     */
    public int getRound() {
        final Integer round = StyleManager.getPainterPropertyValue(panel,
                "round");
    ...
    public int getShadeWidth() {
        final Integer shadeWidth = StyleManager.getPainterPropertyValue(panel,
                "shadeWidth");
    ...
    public float getShadeTransparency() {
        final Float shadeTransparency = StyleManager.getPainterPropertyValue(
                panel, "shadeTransparency");
        return shadeTransparency != null ? shadeTransparency
                : WebPanelStyle.shadeTransparency;
    }
    ...
    public void setShadeTransparency(final float transparency) {
        StyleManager.setCustomPainterProperty(panel, "shadeTransparency",
                transparency);
    }
    ...
    public Stroke getBorderStroke() {
        final Stroke borderStroke = StyleManager.getPainterPropertyValue(panel,
                "borderStroke");
    ...
    public Color getBorderColor() {
        final Color borderColor = StyleManager.getPainterPropertyValue(panel,
                "borderColor");
    ...
    public Color getDisabledBorderColor() {
        final Color disabledBorderColor = StyleManager.getPainterPropertyValue(
                panel, "disabledBorderColor");
        return disabledBorderColor != null ? disabledBorderColor
                : WebPanelStyle.disabledBorderColor;
    }
    ...
    public void setDisabledBorderColor(final Color color) {
        StyleManager.setCustomPainterProperty(panel, "disabledBorderColor",
                color);
    }
    ...
    public boolean isPaintBackground() {
        final Boolean paintBackground = StyleManager.getPainterPropertyValue(
                panel, "paintBackground");
        return paintBackground != null ? paintBackground
                : WebPanelStyle.paintBackground;
    }
    ...
    public boolean isWebColoredBackground() {
        final Boolean webColored = StyleManager.getPainterPropertyValue(panel,
                "webColoredBackground");
        return webColored != null ? webColored
                : WebPanelStyle.webColoredBackground;
    }
    ...
    public void setWebColoredBackground(final boolean webColored) {
        StyleManager.setCustomPainterProperty(panel, "webColoredBackground",
                webColored);
    }
    ...
    public void setPainter(final Painter painter) {
        ...
        final PanelPainter properPainter = LafUtils.getProperPainter(painter,
                PanelPainter.class, AdaptivePanelPainter.class);
    ...
    private void applyPainterSettings(final PanelPainter painter) {
        if (painter != null) {
            ...
            painter.setPaintSideLines(paintTopLine, paintLeftLine,
