...
public class WebPanel extends JPanel implements Styleable, ShapeProvider,
        PartialDecoration, EventMethods, ToolTipMethods, SizeMethods<WebPanel>,
     ...
     *
     * @param decorated
     *            whether panel should be decorated or not
     */
    ...
    /**
     * Constructs new panel with the specified layout which is either decorated
     * or undecorated.
     *
     * @param decorated
     *            whether panel should be decorated or not
    ...
    /**
     * Constructs new panel which is either decorated or undecorated. Also the
     * specified component is automatically added into panel's center area.
     *
     * @param decorated
     *            whether panel should be decorated or not
     * @param component
    ...
    /**
     * Constructs new panel with the specified component automatically added
     * into panel's center area.
     *
     * @param component
     *            component to add into the panel
     */
    ...
    /**
     * Constructs new panel with the specified painter. Also the specified
     * component is automatically added into panel's center area.
     *
     * @param painter
     *            panel painter
     * @param component
    ...
    /**
     * Constructs new panel with the specified layout and painter. Also the
     * specified components are automatically added into panel's center area.
     *
     * @param layout
     *            panel layout
     * @param painter
     ...
     *            whether panel should be double-buffered or not
     */
    ...
    /**
     * Constructs new panel with the specified layout. Also the specified
     * components are automatically added into panel's center area.
     *
     * @param layout
     *            panel layout
     * @param components
     ...
     * @return true if the specified component belongs to this container, false
     *         otherwise
     */
    ...
    /**
     * Adds all components from the list into the panel under the specified
     * index.
     *
     * @param components
     *            components to add into panel
    ...
    /**
     * Adds all components into the panel under the specified constraints. It
     * might be a rare case when you would require to put more than one
     * component under the same constraint, but it is possible.
     *
     * @param constraints
     *            constraints for all components
     * @param components
    ...
    /**
     * Adds all specified components into the panel. Useful for layouts like
     * FlowLayout and some others.
     *
     * @param components
     *            components to add into panel
     * @return this panel
     ...
     *
     * @param components
     *            components to remove from panel
     * @return this panel
     */
     ...
     *            class type of child components to be removed
     * @return this panel
     */
    ...
    /**
     * Returns whether focus should be painted or not. Panel focus is displayed
     ...
     * @return this panel
     */
    public WebPanel setMargin(final int top, final int left, final int bottom,
            final int right) {
    ...
    public void updateUI() {
        if (getUI() == null || !(getUI() instanceof WebPanelUI)) {
            try {
                setUI((WebPanelUI) ReflectUtils
                        .createInstance(FlatLafSettings.panelUI));
    ...
    public Dimension getPreferredSize() {
        Dimension ps = SizeUtils.getPreferredSize(this,
