...
public class WebPasswordField extends JPasswordField implements ShapeProvider,
        DocumentEventMethods, EventMethods, ToolTipMethods, LanguageMethods,
        SettingsMethods, FontMethods<WebPasswordField>,
    ...
    public WebPasswordField(final Document doc, final String txt,
            final int columns) {
    ...
    public void updateUI() {
        ...
        if (getUI() == null || !(getUI() instanceof WebPasswordFieldUI)) {
            try {
                setUI((WebPasswordFieldUI) ReflectUtils
                        .createInstance(FlatLafSettings.passwordFieldUI));
     ...
     */
    @Override
    public WebPasswordField setFontStyle(final boolean bold,
     ...
     */
    @Override
    public WebPasswordField setFontSizeAndStyle(final int fontSize,
