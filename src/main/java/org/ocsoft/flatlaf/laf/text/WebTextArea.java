...
public class WebTextArea extends JTextArea implements DocumentEventMethods,
    ...
    public WebTextArea(final Document doc, final String text, final int rows,
            final int columns) {
    ...
    public void setInputPromptHorizontalPosition(
        ...
        getWebUI().setInputPromptHorizontalPosition(
    ...
    public void updateUI() {
        if (getUI() == null || !(getUI() instanceof WebTextAreaUI)) {
            try {
                setUI((WebTextAreaUI) ReflectUtils
                        .createInstance(FlatLafSettings.textAreaUI));
     ...
     */
    @Override
    public WebTextArea setFontSizeAndStyle(final int fontSize,
