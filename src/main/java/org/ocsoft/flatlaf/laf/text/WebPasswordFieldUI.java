...
public class WebPasswordFieldUI extends BasicPasswordFieldUI implements
        ShapeProvider, SwingConstants, BorderMethods {
    ...
    public void setPainter(final Painter painter) {
        ...
        getComponent().setOpaque(
                painter == null || painter.isOpaque(passwordField));
        PainterSupport.installPainter(passwordField, this.painter);
        updateBorder();
    }
    ...
    public void updateBorder() {
        if (passwordField != null) {
            ...
            final boolean ltr = passwordField.getComponentOrientation()
                    .isLeftToRight();
    ...
    protected void paintSafely(final Graphics g) {
        ...
        if (painter != null || drawBorder) {
            ...
            if (painter != null) {
                ...
                if (drawShade) {
                    shadeColor = drawFocus && c.isFocusOwner() ? FlatLafStyleConstants.fieldFocusColor
        ...
        if (isInputPromptVisible(c)) {
            ...
            } else if (ltr && inputPromptPosition == LEADING || !ltr
                    && inputPromptPosition == TRAILING
                    || inputPromptPosition == LEFT) {
                x = b.x;
            } else {
    ...
    public Dimension getPreferredSize(final JComponent c) {
        ...
        // Fix for Swing bug with pointless scrolling when field's default
        // preferred size is already reached
        ps.width += 1;
