...
public class WebSeparator extends JSeparator {
    ...
    public WebSeparator(final boolean drawLeadingLine,
            final boolean drawTrailingLine) {
        super();
    ...
    public WebSeparator(final boolean drawLeadingLine,
            final boolean drawTrailingLine, final int orientation) {
        super(orientation);
        setDrawLeadingLine(drawLeadingLine);
        setDrawTrailingLine(drawTrailingLine);
    }
    ...
    public WebSeparator setMargin(final int top, final int left,
    ...
    public void updateUI() {
        if (getUI() == null || !(getUI() instanceof WebSeparatorUI)) {
            try {
                setUI((WebSeparatorUI) ReflectUtils
                        .createInstance(FlatLafSettings.separatorUI));
