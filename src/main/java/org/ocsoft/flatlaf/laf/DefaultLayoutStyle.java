 ...
 * otherwise 12. This class also provides helper methods for subclasses.
 *
 * @author Mikle Garin
 */
...
public class DefaultLayoutStyle extends LayoutStyle {
    ...
    /**
     * Returns true if the classes identify a JLabel and a non-JLabel along the
     * horizontal axis, false otherwise.
     *
     * @param c1
     *            first component
     * @param c2
     ...
     * @return true if the classes identify a JLabel and a non-JLabel along the
     *         horizontal axis, false otherwise
     */
    protected boolean isLabelAndNonlabel(final JComponent c1,
            final JComponent c2, final int position) {
     ...
     * paint the border, yet they have padding for a border. Look and feel
     * guidelines generally don't include this space. Use this method to
     * subtract this space from the specified components.
     *
     * @param source
     *            first component
     * @param target
     ...
     */
    protected int getButtonGap(final JComponent source,
            final JComponent target, final int position, int offset) {
     ...
     * @return offset - border/margin around the component
     */
    protected int getButtonGap(final JComponent source, final int position,
            int offset) {
        offset -= getButtonGap(source, position);
    ...
    /**
     * If {@code c} is a check box or radio button, and the border is not
     * painted this returns the inset along the specified axis.
     *
     * @param c
     *            component
     * @param position
     ...
     * @param position
     *            position doing layout along
     * @return the amount to indent the specified component if it's a JCheckBox
     *         or JRadioButton or zero if it is not
     */
     ...
     */
    private boolean isLeftAligned(final AbstractButton button,
            final int position) {
     ...
     */
    private boolean isRightAligned(final AbstractButton button,
            final int position) {
