...
public class WebScrollBarUI extends BasicScrollBarUI implements Styleable,
        BorderMethods {
    /**
     * todo 1. Return painters taken directly from the buttons to avoid
     * inconsistance todo 2. Probably fire additional button-painter change
     * events? Or just leave it for button UIs?
     */
     ...
     *
     * @return true if scroll bar arrow buttons should be displayed, false
     *         otherwise
     */
     ...
     *
     * @param painter
     *            new scroll bar painter
     */
    public void setPainter(final Painter painter) {
        // Creating adaptive painter if required
        final ScrollBarPainter properPainter = LafUtils
                .getProperPainter(painter, ScrollBarPainter.class,
    ...
    /**
     * Returns decrease button painter. This the button displayed at top or left
    ...
    /**
     * Sets decrease button painter. This the button displayed at top or left
     * side of the scroll bar.
     *
     * @param painter
     *            new decrease button painter
     */
    public void setDecreaseButtonPainter(final Painter painter) {
        // Creating adaptive painter if required
        final ScrollBarButtonPainter properPainter = LafUtils.getProperPainter(
                painter, ScrollBarButtonPainter.class,
                AdaptiveScrollBarButtonPainter.class);
    ...
    /**
     * Returns increase button painter. This the button displayed at bottom or
     * right side of the scroll bar.
     *
    ...
    /**
     * Sets increase button painter. This the button displayed at bottom or
     * right side of the scroll bar.
     *
     * @param painter
     *            new increase button painter
     */
    ...
    /**
     * Paints scroll bar decorations. The whole painting process is delegated to
    ...
    protected void installComponents() {
        final WebButton db = new WebButton(decreaseButtonPainter) {
            ...
            public Dimension getPreferredSize() {
                // The best way (so far) to hide buttons without causing a
                // serious mess in the code
                return painter != null && paintButtons ? super
    ...
    public Dimension getPreferredSize(final JComponent c) {
        ...
        Dimension ps = ver ? new Dimension(scrollBarWidth, 48) : new Dimension(
                48, scrollBarWidth);
        
        // Arrow button preferred sizes
        if (painter != null && paintButtons && decrButton != null
                && incrButton != null) {
            ...
            if (ver) {
                ...
                ps.height = Math.max(ps.height,
                        Math.max(dps.height, ips.height));
            }
        }
