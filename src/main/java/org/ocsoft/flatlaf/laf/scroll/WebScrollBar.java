...
public class WebScrollBar extends JScrollBar implements Styleable,
     ...
     */
    public WebScrollBar(final int orientation, final int value,
            final int extent, final int min, final int max) {
     ...
     *
     * @param top
     *            new scroll bar content top margin
     * @param left
     *            new scroll bar content left margin
     * @param bottom
     *            new scroll bar content bottom margin
     * @param right
     *            new scroll bar content right margin
     * @return scroll bar
     */
    public WebScrollBar setMargin(final int top, final int left,
    ...
    public void updateUI() {
        if (getUI() == null || !(getUI() instanceof WebScrollBarUI)) {
            try {
                setUI((WebScrollBarUI) ReflectUtils
                        .createInstance(FlatLafSettings.scrollBarUI));
