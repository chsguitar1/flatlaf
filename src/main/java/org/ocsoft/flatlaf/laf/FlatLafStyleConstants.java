...
public class FlatLafStyleConstants {
    ...
    public static final ImageIcon EMPTY_ICON = new ImageIcon(
            FlatLafStyleConstants.class.getResource("icons/empty.png"));
    ...
    public static Color transparentFieldFocusColor = new Color(85, 142, 239,
            128);
    public static FocusType focusType = FocusType.fieldFocus;
    public static Stroke fieldFocusStroke = new BasicStroke(1.5f);
    public static Stroke focusStroke = new BasicStroke(1,
            BasicStroke.CAP_ROUND, BasicStroke.JOIN_ROUND, 1, new float[] { 1,
                    2 }, 0);
     ...
     */
    public static Map defaultTextRenderingHints = new RenderingHints(
                ...
                new PropertyChangeListener() {
                    ...
                    public void propertyChange(final PropertyChangeEvent evt) {
                        if (evt.getNewValue() instanceof RenderingHints) {
                            textRenderingHints = (RenderingHints) evt
                                    .getNewValue();
                        }
                    }
                });
     ...
     */
    public static Stroke guidelinesStroke = new BasicStroke(1,
            BasicStroke.CAP_ROUND, BasicStroke.JOIN_ROUND, 1, new float[] { 4,
                    4 }, 0);
    
    /**
     * HTML renderer icons.
     */
    public static ImageIcon htmlPendingIcon = new ImageIcon(
            FlatLafStyleConstants.class
                    .getResource("icons/html/pendingImage.png"));
    public static ImageIcon htmlMissingIcon = new ImageIcon(
            FlatLafStyleConstants.class
                    .getResource("icons/html/missingImage.png"));
