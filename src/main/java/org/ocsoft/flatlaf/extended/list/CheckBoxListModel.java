 ...
 * default model methods to avoid casting to checkbox cell data object. There
 * are also methods to add new elements and change/retrieve checkbox selection
 * state.
 *
 * @author Mikle Garin
 */
...
public class CheckBoxListModel extends WebListModel<CheckBoxCellData> {
    ...
    /**
     * Adds new checkbox cell data with a specified user object and checkbox
     * selection state into list model.
     *
     * @param userObject
     *            user object
     * @param selected
     *            whether checkbox selected or not
     */
    public void addCheckBoxElement(final Object userObject,
    ...
    /**
     * Adds new checkbox cell data with a specified user object and checkbox
     * selection state into list model at the specified index.
     *
     * @param index
     *            new cell index
     * @param userObject
    ...
    /**
     * Sets whether checkbox at the specified cell index is selected or not and
     * returns whether selection has changed or not.
     *
     * @param index
     *            cell index
     * @param selected
