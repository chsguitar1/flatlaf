...
public class FileListModel extends WebListModel<FileElement> {
    ...
    /**
     * Constructs file list model with files from directory under the specified
     * path.
     *
     * @param directoryPath
     *            directory path
    ...
    private void clearCache() {
        synchronized (elementsCacheLock) {
            for (Map.Entry<String, FileElement> entry : elementsCache
                    .entrySet()) {
    ...
    /**
     * Returns FileElement for the specified file or null if it is not in the
     * list.
     *
     * @param file
     *            file to process
     * @return FileElement for the specified file or null if it is not in the
     *         list
     */
    ...
    /**
     * Returns FileElement for the file with specified path or null if it is not
     * in the list.
     *
     * @param path
     *            file path to process
     * @return FileElement for the file with specified path or null if it is not
     *         in the list
     */
    ...
    /**
     * Clears list data and fills it with files from directory under the
     * specified path.
     *
     * @param directoryPath
