 ...
 * popup menu. You can specify the displayed menu using setPopupMenu method.
 *
 * @author Mikle Garin
 * @see WebButton
...
public class WebSplitButton extends WebButton implements MouseMotionListener,
    ...
    /**
     * Sets the popup menu to be displayed, when the split part of the button is
     * clicked.
     *
     * @param popupMenu
     *            popup menu to be displayed, when the split part of the button
     *            is clicked
     */
    ...
    /**
     * Returns whether should always display popup menu when button is clicked
     * or not.
     *
     * @return true if should always display popup menu when button is clicked,
     *         false otherwise
     */
    ...
    /**
     * Sets whether should always display popup menu when button is clicked or
     * not.
     *
     * @param alwaysShowMenu
     *            whether should always display popup menu when button is
     *            clicked or not
     */
    ...
    /**
     * Sets approximate popup menu display way. This will have effect only if
     * WebPopupMenuUI is used as popup menu UI. Otherwise this variable will
     * have no effect on popup menu display way.
     *
     * @param way
     ...
     *
     * @param listener
     *            the SplitButtonListener to be added
     */
    ...
    /**
     * Removes SplitButtonListener from the button. If the listener is the
     * currently set Action for the button, then the Action is set to null.
     *
     * @param listener
     *            the SplitButtonListener to be removed
     */
    ...
    public void showPopupMenu() {
        ...
        if (getComponentOrientation().isLeftToRight()) {
            ...
            popupMenu.show(this, getWidth()
                    - popupMenu.getPreferredSize().width, getHeight());
        }
    }
        ...
        for (int i = listeners.length - 2; i >= 0; i -= 2) {
            if (listeners[i] == SplitButtonListener.class) {
                ...
                if (e == null) {
                    ...
                    e = new ActionEvent(WebSplitButton.this,
    ...
    public void updateUI() {
        if (getUI() == null || !(getUI() instanceof WebSplitButtonUI)) {
            try {
                setUI((WebSplitButtonUI) ReflectUtils
                        .createInstance(FlatLafSettings.splitButtonUI));
