...
/**
 * This class represents custom text style for WebStyledLabel component. It
 * contains various style settings supported by the styled label UI.
 *
 * @author Mikle Garin
 * @see org.ocsoft.flatlaf.extended.label.WebStyledLabel
 */
...
public class StyleRange {
     ...
     * Custom text styles.
     *
     * @see org.ocsoft.flatlaf.extended.label.CustomStyle
     */
    ...
    public StyleRange(final StyleRange styleRange) {
        this(styleRange.getStartIndex(), styleRange.getLength(), styleRange
                .getStyle(), styleRange.getForeground(), styleRange
                .getBackground(), getCustomStyles(styleRange));
    }
     ...
     *            custom text styles
     */
    public StyleRange(final int startIndex, final int length,
     ...
     *            custom text styles
     */
    public StyleRange(final int startIndex, final int length, final int style,
            final CustomStyle... customStyles) {
     ...
     */
    public StyleRange(final int startIndex, final int length,
            final Color foreground, final CustomStyle... customStyles) {
    ...
    public StyleRange(final int startIndex, final int length, final int style,
        ...
        if (startIndex < 0) {
            throw new IllegalArgumentException(
                    "Style start index cannot be less than zero");
        }
        if (length == 0) {
    ...
    protected static CustomStyle[] getCustomStyles(final StyleRange styleRange) {
        return styleRange.getCustomStyle().toArray(
                new CustomStyle[styleRange.getCustomStyle().size()]);
    }
}