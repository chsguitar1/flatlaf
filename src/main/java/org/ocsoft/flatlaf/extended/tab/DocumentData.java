...
public class DocumentData<C extends Component> {
    /**
     * Document data listeners. Used to properly update WebDocumentPane view on
     * document changes.
     */
    protected transient List<DocumentDataListener> listeners = new ArrayList<DocumentDataListener>(
            1);
    
    /**
     * Document ID. This ID have to be unique only within single WebDocumentPane
     * instance.
     */
    protected String id;
    ...
    /**
     * Document title. This can be a plain text or a language key. Whether this
     * is a plain text or a language key will be determined automatically, you
     * only have to provide it.
     */
    ...
    /**
     * Document tab background color. Used to color tab and tab content
     * background.
     */
    protected Color background;
    
    /**
     * Whether this document is closeable or not. All documents are closeable by
     * default, but you may change that.
     */
    protected boolean closeable;
    
    /**
     * Whether this document is draggable or not. All documents are draggable by
     * default, but you may change that.
     */
     ...
     *            document content
     */
    public DocumentData(final String id, final Icon icon, final String title,
            final C component) {
     ...
     */
    public DocumentData(final String id, final Icon icon, final String title,
            final Color background, final C component) {
     ...
     *            document tab background color
     * @param closeable
     *            whether document is closeable or not
     * @param component
     *            document content
     */
    public DocumentData(final String id, final Icon icon, final String title,
            final Color background, final boolean closeable, final C component) {
     ...
     *            whether document is closeable or not
     * @param draggable
     *            whether document is draggable or not
     * @param component
     *            document content
     */
    public DocumentData(final String id, final Icon icon, final String title,
            final Color background, final boolean closeable,
            final boolean draggable, final C component) {
        this(id, icon, title, Color.BLACK, background, closeable, draggable,
                component);
    }
     ...
     *
     * @param listener
     *            document data listener to remove
     */
    ...
    public void fireTitleChanged() {
        for (final DocumentDataListener listener : CollectionUtils
                .copy(listeners)) {
     ...
     */
    public void fireBackgroundChanged(final Color oldBackground,
     ...
     *            new tab content
     */
    public void fireContentChanged(final Component oldComponent,
