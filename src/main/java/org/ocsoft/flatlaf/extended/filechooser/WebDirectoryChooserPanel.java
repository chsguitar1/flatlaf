 ...
 * to file chooser component but has its own unique interface and doesn't need a
 * lot of configuring to use.
 *
 * @author Mikle Garin
 */
...
public class WebDirectoryChooserPanel extends WebPanel {
     ...
     * Used icons.
     */
    protected static final ImageIcon FOLDER_UP_ICON = new ImageIcon(
            WebDirectoryChooserPanel.class.getResource("icons/folder_up.png"));
    protected static final ImageIcon FOLDER_HOME_ICON = new ImageIcon(
            WebDirectoryChooserPanel.class.getResource("icons/folder_home.png"));
    protected static final ImageIcon FOLDER_NEW_ICON = new ImageIcon(
            WebDirectoryChooserPanel.class.getResource("icons/folder_new.png"));
    protected static final ImageIcon REFRESH_ICON = new ImageIcon(
            WebDirectoryChooserPanel.class.getResource("icons/refresh.png"));
    protected static final ImageIcon REMOVE_ICON = new ImageIcon(
            WebDirectoryChooserPanel.class.getResource("icons/remove.png"));
    ...
    public WebDirectoryChooserPanel() {
        ...
        folderUp.addHotkey(WebDirectoryChooserPanel.this, Hotkey.ALT_UP)
        ...
        folderUp.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(final ActionEvent e) {
                if (selectedDirectory != null) {
                    updateSelectedDirectory(selectedDirectory.getParentFile(),
                            true, true);
                }
            }
        });
        ...
        folderHome.addHotkey(WebDirectoryChooserPanel.this, Hotkey.ALT_H)
        ...
        refresh.addHotkey(WebDirectoryChooserPanel.this, Hotkey.F5)
        ...
        folderNew.addHotkey(WebDirectoryChooserPanel.this, Hotkey.CTRL_N)
                .setHotkeyDisplayWay(TooltipWay.down);
            ...
            public void actionPerformed(final ActionEvent e) {
                if (selectedDirectory != null) {
                    final String defaultName = LanguageManager
                            .get("weblaf.ex.dirchooser.newfolder.name");
                    final String freeName = FileUtils.getAvailableName(
                            selectedDirectory, defaultName);
                    ...
                    if (file.mkdir()) {
                        ...
                        final String message = LanguageManager
                                .get("weblaf.ex.dirchooser.newfolder.error.text");
                        final String title = LanguageManager
                                .get("weblaf.ex.dirchooser.newfolder.error.title");
                        WebOptionPane.showMessageDialog(
                                WebDirectoryChooserPanel.this, message, title,
        ...
        remove.addHotkey(WebDirectoryChooserPanel.this, Hotkey.DELETE)
                .setHotkeyDisplayWay(TooltipWay.down);
        ...
        remove.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(final ActionEvent e) {
                ...
                final String message = LanguageManager
                        .get("weblaf.ex.dirchooser.delete.confirm.text");
                final String title = LanguageManager
                        .get("weblaf.ex.dirchooser.delete.confirm.title");
                ...
                if (confirm == WebOptionPane.YES_OPTION) {
                    ...
                    final FileTreeNode parentNode = fileTree.getSelectedNode()
                            .getParent();
                    ...
                    fileTree.setSelectedNode(count == 1 ? parentNode
                            : (index < count - 1 ? parentNode.getChildAt(index)
        ...
        webPathField.addPathFieldListener(new PathFieldListener() {
            ...
            public void directoryChanged(final File newDirectory) {
                updateSelectedDirectory(webPathField.getSelectedPath(), false,
                        true);
            }
        });
    ...
    protected void updateToolbarControlsState() {
        ...
        folderUp.setEnabled(selectedFile != null
                && selectedFile.getParentFile() != null);
        
        folderNew.setEnabled(selectedFile != null && selectedFile.canWrite());
        remove.setEnabled(selectedFile != null
                && selectedFile.getParentFile() != null
     ...
     *            directory to select
     * @param updatePath
     *            whether to update path field or not
     * @param updateTree
     *            whether to update file tree or not
     */
    protected void updateSelectedDirectory(final File directory,
            final boolean updatePath, final boolean updateTree) {
    ...
    public boolean allowHotkeys() {
        ...
        return !fileTree.isEditing() && !webPathField.isEditing() /*
                                                                   * &&
                                                                   * !fileList
                                                                   * .isEditing
                                                                   * ()
    ...
    protected void fireSelectionChanged(final File file) {
        for (final DirectoryChooserListener listener : CollectionUtils
                .copy(listeners)) {
