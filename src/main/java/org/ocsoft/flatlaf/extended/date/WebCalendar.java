...
import org.ocsoft.flatlaf.extended.transition.TransitionAdapter;
...
public class WebCalendar extends WebPanel {
     ...
     * Used icons.
     */
    public static final ImageIcon previousSkipIcon = new ImageIcon(
            WebCalendar.class.getResource("icons/previous_skip.png"));
    public static final ImageIcon previousIcon = new ImageIcon(
            WebCalendar.class.getResource("icons/previous.png"));
    public static final ImageIcon nextIcon = new ImageIcon(
            WebCalendar.class.getResource("icons/next.png"));
    public static final ImageIcon nextSkipIcon = new ImageIcon(
            WebCalendar.class.getResource("icons/next_skip.png"));
    ...
    public WebCalendar(final Date date) {
        ...
        previousSkip = WebButton.createIconWebButton(previousSkipIcon,
                FlatLafStyleConstants.smallRound, true);
        ...
        weekHeaders.setMargin(FlatLafStyleConstants.shadeWidth,
    ...
    protected WebPanel createMonthPanel() {
        ...
        monthDays.setMargin(FlatLafStyleConstants.shadeWidth - 1,
                FlatLafStyleConstants.shadeWidth - 1,
                FlatLafStyleConstants.shadeWidth - 1,
                FlatLafStyleConstants.shadeWidth - 1);
