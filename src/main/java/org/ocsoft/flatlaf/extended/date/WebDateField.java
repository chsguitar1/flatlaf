 ...
 *
 * @author Mikle Garin
 * @see org.ocsoft.flatlaf.extended.date.WebCalendar
 */

public class WebDateField extends WebFormattedTextField implements
        ShapeProvider, SettingsMethods, SizeMethods<WebFormattedTextField> {
    /**
     ...
     * Used icons.
     */
    public static final ImageIcon selectDateIcon = new ImageIcon(
            WebDateField.class.getResource("icons/date.png"));
    ...
    /**
     * Whether or not selection events must be fired whenever selection occured
     * even if same date is selected.
     */
    ...
    public WebDateField(final Date date, final boolean drawBorder) {
        ...
        // Popup button
        popupButton = WebButton.createIconWebButton(selectDateIcon,
                WebDateFieldStyle.round);
     ...
     *
     * @param customizer
     *            new calendar component customizer
     */
    ...
    protected void updateMargin() {
        setMargin(isDrawBorder() ? WebDateFieldStyle.margin
                : WebDateFieldStyle.undecoratedMargin);
    }
    ...
    protected void updatePopupLocation() {
        ...
        final boolean ltr = WebDateField.this.getComponentOrientation()
                .isLeftToRight();
    ...
    /**
     * Forces date to be updated with valid value. In case field contains valid
     * date in its text it will be used, otherwise old date will be applied.
     */
    ...
    /**
     * Sets currently selected date and updates component depending on update
     * source.
     *
     * @param date
     *            new selected date
    ...
    /**
     * Returns whether or not selection events must be fired whenever selection
     * occured even if same date is selected.
     *
     * @return true if selection events must be fired whenever selection occured
     *         even if same date is selected, false otherwise
     */
    ...
    /**
     * Sets whether or not selection events must be fired whenever selection
     * occured even if same date is selected.
     *
     * @param fire
     *            whether or not selection events must be fired whenever
     *            selection occured even if same date is selected
     */
