 ...
 * install this listener onto any component to make it move the window when
 * dragged. You can specify moved window/component or simply let the listener
 * detect it.
 *
 * @author Mikle Garin
 */
...
public class ComponentMoveAdapter extends MouseAdapter {
    ...
    /**
     * Component that should be dragged. If set to null mouse events source
     * component parent window will be dragged instead.
     */
     ...
     *
     * @param component
     *            window component that will act as gripper
     */
     ...
     * @param toDrag
     *            component to be moved by the gripper component
     */
    ...
    /**
     * Constructs new component move adapter that alows source component parent
     * window dragging.
     */
    ...
    /**
     * Constructs new component move adapter that allows specified component
     * dragging.
     *
     * @param toDrag
     *            component to drag
        ...
        if (SwingUtilities.isLeftMouseButton(e)) {
            ...
            if (dragged != null) {
                ...
                if (dragStartBounds != null
                        && dragStartBounds.contains(e.getPoint())) {
                    dragging = true;
    ...
    public void mouseDragged(final MouseEvent e) {
        if (dragging) {
            ...
            dragged.setLocation(initialBounds.x + (point.x - initialPoint.x),
                    initialBounds.y + (point.y - initialPoint.y));
        }
    }
    ...
    protected Component getDraggedComponent(final MouseEvent e) {
        return toDrag == null ? SwingUtils.getWindowAncestor(e.getComponent())
                : toDrag;
    }
