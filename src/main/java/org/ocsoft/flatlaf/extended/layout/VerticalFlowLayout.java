...
public class VerticalFlowLayout extends AbstractLayoutManager {
    /**
     * todo 1. Return possibility to wrap columns? todo 2. Vertical alignment
     * (in column)?
     */
     ...
     */
    public VerticalFlowLayout(final int align, final boolean hfill,
            final boolean vfill) {
    ...
    public void layoutContainer(final Container target) {
        ...
        final int pheight = !vfill && align != TOP ? calculatePreferredHeight(target)
                : 0;
        ...
        for (int i = 0; i < numcomp; i++) {
            ...
            if (component.isVisible()) {
                ...
                final int h = vfill && i == numcomp - 1 ? maxheight - y
                        : ps.height;
                if (vfill) {
                    ...
                    switch (align) {
                    case MIDDLE: {
                        component.setBounds(insets.left, insets.top + maxheight
                                / 2 - pheight / 2 + y, w, ps.height);
                        break;
                    }
                    case BOTTOM: {
                        component.setBounds(insets.left, size.height
                                - insets.bottom - pheight + y, w, ps.height);
                        break;
                    }
                    default: {
                        component.setBounds(insets.left, insets.top + y, w,
                                ps.height);
                        break;
                    }
                    }
     ...
     *
     * @param target
     *            container to calculate components preferred height for
