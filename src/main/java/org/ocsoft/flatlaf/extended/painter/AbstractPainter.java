 ...
 * Painter interface. Usually this class is extended by various painters instead
 * of implementing Painter interface directly.
 *
 * @param <E>
 *            component type
 * @author Mikle Garin
...
public abstract class AbstractPainter<E extends JComponent> implements
        Painter<E> {
    /**
     ...
     * Painter listeners.
     */
    protected List<PainterListener> listeners = new ArrayList<PainterListener>(
            1);
     ...
     *
     * @param opaque
     *            whether visual data provided by this painter is opaque or not
     */
     ...
     *
     * @param preferredSize
     *            preferred size for visual data provided by this painter
     */
     ...
     *
     * @param top
     *            top margin required for visual data provided by this painter
     * @param left
     *            left margin required for visual data provided by this painter
     * @param bottom
     *            bottom margin required for visual data provided by this
     *            painter
     * @param right
     *            right margin required for visual data provided by this painter
     */
    ...
    /**
     * Should be called when painter size, border and visual representation
     * changes. Calls both revalidate and update listener methods.
     */
    ...
    /**
     * Returns point for the specified coordinates. Might be useful for points
     * generation in various cases
     *
     * @param x
     *            X coordinate
     * @param y
