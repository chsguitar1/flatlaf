 ...
 * within the specific UIs. To use it properly you should extend this class and
 * implement UI painter interface methods. In general cases those methods might
 * have no effect since general-type painters do not know anything about
 * component specifics.
 *
 * @author Mikle Garin
 */

public abstract class AdaptivePainter<E extends JComponent> extends
        AbstractPainter<E> {
    /**
     * Adapted painter.
     */
