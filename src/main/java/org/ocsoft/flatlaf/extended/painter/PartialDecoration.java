...
/**
 * This interface should be implemented by any component/UI/painter that
 * supports partial decoration. It will allow component view to be configured
 * dynamically, according to its location in the application. These methods can
 * also be used to configure component decoration manually.
 *
 * @author Mikle Garin
 */
...
public interface PartialDecoration {
     ...
     *
     * @param top
     *            whether should paint top side or not
     */
     ...
     *
     * @param left
     *            whether should paint left side or not
     */
     ...
     *
     * @param bottom
     *            whether should paint bottom side or not
     */
     ...
     *
     * @param right
     *            whether should paint right side or not
     */
     ...
     *            whether should paint right side or not
     */
    public void setPaintSides(boolean top, boolean left, boolean bottom,
            boolean right);
     ...
     *
     * @param left
     *            whether should paint left side line or not
     */
     ...
     *
     * @param bottom
     *            whether should paint bottom side line or not
     */
     ...
     *            whether should paint right side line or not
     */
    public void setPaintSideLines(boolean top, boolean left, boolean bottom,
            boolean right);
}