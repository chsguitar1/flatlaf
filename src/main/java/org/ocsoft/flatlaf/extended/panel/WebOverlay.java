 ...
 * <p/>
 * This component allows you to add one or more custom overlaying components
 * atop of other component. This will work with any kind of Swing components -
 * you can overlay anyhting with something like loader, progress bar, custom
 * text, image or anything else.
 */
...
public class WebOverlay extends WebPanel implements SwingConstants {
    ...
    public WebOverlay(Component component, Component overlay, int halign,
            int valign) {
        super(new OverlayLayout());
        initialize();
        setComponent(component);
