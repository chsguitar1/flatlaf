 ...
 * or a column. You can specify grouping type, orientation and gap between
 * components.
 * <p/>
 * If specified grouping type is not "none" then components will be placed
 * according to that grouping type. Otherwise whether component should fill all
 * the space left or not is determined by its FILL_CELL client property.
 * <p/>
 * Orientation determines whether components should be placed horizontally or
 * vertically.
 * <p/>
...
public class GroupPanel extends WebPanel {
    /**
     * Key for boolean value that is used to determine when component should
     * fill all the space left.
     */
    public static final String FILL_CELL = "fill.component.cell";
    
    /**
     * Constructor that places components horizontally in a single row with a
     * zero gap.
     *
     * @param components
     *            components to place
    ...
    /**
     * Constructor that places components horizontally or vertically in a single
     * row with a zero gap.
     *
     * @param horizontal
     *            layout orientation
     ...
     *            components to place
     */
    public GroupPanel(final int gap, final boolean horizontal,
    ...
    /**
     * Constructor that places components horizontally in a single row with a
     * zero gap using special grouping type.
     *
     * @param groupingType
     *            special grouping type
     * @param components
     *            components to place
     */
    public GroupPanel(final GroupingType groupingType,
            final Component... components) {
    ...
    /**
     * Constructor that places components horizontally or vertically in a single
     * row with a zero gap using special grouping type.
     *
     * @param groupingType
     *            special grouping type
     * @param horizontal
     ...
     */
    public GroupPanel(final GroupingType groupingType,
            final boolean horizontal, final Component... components) {
        this(groupingType, 0, horizontal, components);
    }
    
    /**
     * Constructor that places components horizontally in a single row with a
     * specified gap using special grouping type.
     *
     * @param groupingType
     *            special grouping type
     * @param gap
     ...
     *            components to place
     */
    public GroupPanel(final GroupingType groupingType, final int gap,
            final Component... components) {
    ...
    /**
     * Constructor that places components horizontally or vertically in a single
     * row with a specified gap using special grouping type.
     *
     * @param groupingType
     *            special grouping type
     * @param gap
    ...
    public GroupPanel(final GroupingType groupingType, final int gap,
            final boolean horizontal, final Component... components) {
        super(new GroupLayout(horizontal ? GroupLayout.HORIZONTAL
        ...
        for (int i = 0; i < components.length; i++) {
            ...
            switch (groupingType) {
            case none: {
                // Client property used to determine whether component should
                // fill all the space left or not
                add(component, isFill(component) ? GroupLayout.FILL
                        : GroupLayout.PREFERRED);
                break;
            }
            case fillFirst: {
                // First component fills all the space left
                add(component, i == 0 ? GroupLayout.FILL
                        : GroupLayout.PREFERRED);
                break;
            }
            case fillMiddle: {
                ...
                add(component,
                        i != 0 && i != components.length - 1 ? GroupLayout.FILL
                                : GroupLayout.PREFERRED);
                break;
            }
            case fillLast: {
                // Last component fills all the space left
                add(component, i == components.length - 1 ? GroupLayout.FILL
                        : GroupLayout.PREFERRED);
                break;
            }
    ...
    /**
     * Sets the layout orientation to either {@code SwingConstants.HORIZONTAL}
     ...
     * @return true if the component should fill all the space left, false
     *         otherwise
     */
    public static boolean isFill(final Component component) {
        if (component instanceof JComponent) {
            final Boolean b = (Boolean) ((JComponent) component)
