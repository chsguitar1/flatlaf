 ...
 * contains all UI methods from the buttons. Those methods apply specific value
 * to all sub-buttons and sub-groups when called. Also this component groups
 * buttons by default.
 *
 * @author Mikle Garin
 */
...
public class WebButtonGroup extends WebPanel implements SwingConstants {
    ...
    public WebButtonGroup(final int orientation, final boolean group,
    ...
    public boolean isAnySelected() {
        return buttonGroup.getSelection() != null
                && buttonGroup.getSelection().isSelected();
    }
    ...
    public void setOrientation(final int orientation) {
        if (this.orientation != orientation) {
            ...
            // Updating layout
            setLayout(orientation == HORIZONTAL ? new HorizontalFlowLayout(0,
                    false) : new VerticalFlowLayout(VerticalFlowLayout.TOP, 0,
                    0, true, false));
    ...
    protected void updateButtonsStyling() {
        ...
        for (int i = 0; i < components.length; i++) {
            if (isWebStyledButton(components[i])) {
                // Web UI
                final FlatButtonUI ui = (FlatButtonUI) ((AbstractButton) components[i])
                        .getUI();
                ...
                if (lastWasButton) {
                    for (final Component component : wbg.getComponents()) {
                        if (isWebStyledButton(component)) {
                            final FlatButtonUI ui = (FlatButtonUI) ((AbstractButton) component)
                                    .getUI();
                            if (horizontal) {
                                ui.setDrawLeft(false);
                                ui.setDrawLeftLine(false);
    ...
    protected void addImpl(final Component comp, final Object constraints,
        ...
        comp.addPropertyChangeListener(FlatLafConstants.ENABLED_PROPERTY,
                enabledStateListener);
    }
    
    @Override
    public void remove(final int index) {
        getComponent(index).removePropertyChangeListener(
                FlatLafConstants.ENABLED_PROPERTY, enabledStateListener);
        super.remove(index);
    }
    ...
    protected boolean isWebStyledButton(final Component component) {
        return isButton(component)
                && ((AbstractButton) component).getUI() instanceof FlatButtonUI;
    }
    ...
    protected void setFocusable(final WebButtonGroup group,
    ...
    protected void setForeground(final WebButtonGroup group,
    ...
    protected void setSelectedForeground(final WebButtonGroup group,
        ...
        for (final Component component : group.getComponents()) {
            if (isWebStyledButton(component)) {
                ...
                setSelectedForeground((WebButtonGroup) component,
                        selectedForeground);
            }
        }
    }
    ...
    protected void setDrawLeft(final WebButtonGroup group,
    ...
    protected void setDrawBottom(final WebButtonGroup group,
    ...
    protected void setDrawBottom(final Component component,
            final boolean drawBottom) {
        if (isWebStyledButton(component)) {
            final FlatButtonUI ui = (FlatButtonUI) ((AbstractButton) component)
                    .getUI();
    ...
    protected void setDrawRight(final WebButtonGroup group,
    ...
    protected void setDrawRight(final Component component,
            final boolean drawRight) {
        if (isWebStyledButton(component)) {
            final FlatButtonUI ui = (FlatButtonUI) ((AbstractButton) component)
                    .getUI();
    ...
    public void setButtonsDrawSides(final boolean top, final boolean left,
    ...
    public void setButtonsRolloverDarkBorderOnly(
            final boolean rolloverDarkBorderOnly) {
        setRolloverDarkBorderOnly(WebButtonGroup.this, rolloverDarkBorderOnly);
    }
    
    protected void setRolloverDarkBorderOnly(final WebButtonGroup group,
            final boolean rolloverDarkBorderOnly) {
        for (final Component component : group.getComponents()) {
            if (isWebStyledButton(component)) {
                final FlatButtonUI ui = (FlatButtonUI) ((AbstractButton) component)
                ...
                setRolloverDarkBorderOnly((WebButtonGroup) component,
    ...
    protected void setRolloverShine(final WebButtonGroup group,
            final boolean rolloverShine) {
        for (final Component component : group.getComponents()) {
            if (isWebStyledButton(component)) {
                final FlatButtonUI ui = (FlatButtonUI) ((AbstractButton) component)
                        .getUI();
    ...
    protected void setShineColor(final WebButtonGroup group,
    ...
    protected void setRolloverShadeOnly(final WebButtonGroup group,
            final boolean rolloverShadeOnly) {
        for (final Component component : group.getComponents()) {
            if (isWebStyledButton(component)) {
                final FlatButtonUI ui = (FlatButtonUI) ((AbstractButton) component)
                        .getUI();
                ...
                setRolloverShadeOnly((WebButtonGroup) component,
                        rolloverShadeOnly);
            }
        }
    }
    ...
    protected void setShadeWidth(final WebButtonGroup group,
    ...
    protected void setShadeColor(final WebButtonGroup group,
    ...
    protected void setInnerShadeWidth(final WebButtonGroup group,
    ...
    protected void setInnerShadeColor(final WebButtonGroup group,
    ...
    protected void setLeftRightSpacing(final WebButtonGroup group,
            final int leftRightSpacing) {
        for (final Component component : group.getComponents()) {
            if (isWebStyledButton(component)) {
                final FlatButtonUI ui = (FlatButtonUI) ((AbstractButton) component)
                        .getUI();
                ...
                setLeftRightSpacing((WebButtonGroup) component,
                        leftRightSpacing);
            }
        }
    }
    
    public void setButtonsRolloverDecoratedOnly(
            final boolean rolloverDecoratedOnly) {
        setRolloverDecoratedOnly(WebButtonGroup.this, rolloverDecoratedOnly);
    }
    
    protected void setRolloverDecoratedOnly(final WebButtonGroup group,
            final boolean rolloverDecoratedOnly) {
        for (final Component component : group.getComponents()) {
            if (isWebStyledButton(component)) {
                final FlatButtonUI ui = (FlatButtonUI) ((AbstractButton) component)
                ...
                setRolloverDecoratedOnly((WebButtonGroup) component,
    ...
    protected void setUndecorated(final WebButtonGroup group,
    ...
    protected void setMoveIconOnPress(final WebButtonGroup group,
            final boolean moveIconOnPress) {
        for (final Component component : group.getComponents()) {
            if (isWebStyledButton(component)) {
                final FlatButtonUI ui = (FlatButtonUI) ((AbstractButton) component)
                        .getUI();
    ...
    protected void setDrawFocus(final WebButtonGroup group,
    ...
    public void setButtonsMargin(final int top, final int left,
