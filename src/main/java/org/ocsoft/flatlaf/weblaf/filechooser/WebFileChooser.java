 ...
 * WebFileChooserUI methods. There is also a set of additional methods that
 * allows to modify chooser view and access its components and data directly.
 *
 * @author Mikle Garin
 */

public class WebFileChooser extends JFileChooser implements LanguageMethods,
    ...
    /**
     * Constructs a WebFileChooser using the given path. Passing in a null
    ...
    /**
     * Constructs a WebFileChooser using the given File as the path. Passing in
     * a null file causes the file chooser to point to the user's default
     * directory.
     *
    ...
    /**
     * Constructs a WebFileChooser using the given current directory and
     * FileSystemView.
     */
    ...
    /**
     * Constructs a WebFileChooser using the given current directory path and
     * FileSystemView.
     */
    public WebFileChooser(final String currentDirectoryPath,
    ...
    public Image getDialogIcon() {
        return customIcons != null && customIcons.size() > 0 ? customIcons
                .get(0) : null;
    }
    ...
    public void updateUI() {
        ...
        if (getUI() == null || !(getUI() instanceof WebFileChooserUI)) {
            try {
                setUI((WebFileChooserUI) ReflectUtils
                        .createInstance(FlatLafSettings.fileChooserUI));
        ...
        ReflectUtils.setFieldValueSafely(this, "uiFileView", getUI()
                .getFileView(this));
    ...
    /**
     * Constructs and displays file open dialog and returns selected file as a
     * result.
     *
     ...
     * @return selected file
     */
    public static File showOpenDialog(final String currentDirectory,
            final Customizer<WebFileChooser> customizer) {
    ...
    /**
     * Constructs and displays multiply files open dialog and returns selected
     * files list as a result.
     *
     ...
     * @return selected files list
     */
    public static List<File> showMultiOpenDialog(final Component parent,
            final Customizer<WebFileChooser> customizer) {
     ...
     * @return selected files list
     */
    public static List<File> showMultiOpenDialog(final String currentDirectory,
            final Customizer<WebFileChooser> customizer) {
    ...
    /**
     * Constructs and displays file save dialog and returns selected file as a
     * result.
     *
     * @return selected file
     */
     ...
     * @return selected file
     */
    public static File showSaveDialog(final String currentDirectory,
            final Customizer<WebFileChooser> customizer) {
