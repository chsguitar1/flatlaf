...
package org.ocsoft.flatlaf.weblaf.slider;
...
public class WebSlider extends JSlider implements EventMethods, ToolTipMethods,
    ...
    public WebSlider(final int orientation, final int min, final int max,
            final int value) {
    ...
    public WebSlider setMargin(final int top, final int left, final int bottom,
            final int right) {
    ...
    public void updateUI() {
        if (getUI() == null || !(getUI() instanceof WebSliderUI)) {
            try {
                setUI((WebSliderUI) ReflectUtils.createInstance(
                        FlatLafSettings.sliderUI, this));
     ...
     */
    @Override
    public WebSlider setFontSizeAndStyle(final int fontSize,
