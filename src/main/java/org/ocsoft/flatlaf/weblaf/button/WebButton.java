...
package org.ocsoft.flatlaf.weblaf.button;
...
public class WebButton extends JButton implements ShapeProvider, EventMethods,
        ToolTipMethods, LanguageMethods, FontMethods<WebButton>,
    ...
    public HotkeyInfo addHotkey(final boolean isCtrl, final boolean isAlt,
            final boolean isShift, final Integer keyCode) {
    ...
    public HotkeyInfo addHotkey(final Component topComponent,
    ...
    public WebButton setRolloverDarkBorderOnly(
    ...
    public WebButton setDefaultButtonShadeColor(
            final Color defaultButtonShadeColor) {
    ...
    public WebButton setRolloverDecoratedOnly(
    ...
    public WebButton setDrawSides(final boolean top, final boolean left,
    ...
    public WebButton setDrawLines(final boolean top, final boolean left,
            final boolean bottom, final boolean right) {
    ...
    public WebButton setMargin(final int top, final int left, final int bottom,
            final int right) {
    ...
    public FlatButtonUI getWebUI() {
        return (FlatButtonUI) getUI();
    }
    
    @Override
    public void updateUI() {
        if (getUI() == null || !(getUI() instanceof FlatButtonUI)) {
            try {
                setUI((FlatButtonUI) ReflectUtils
                        .createInstance(FlatLafSettings.buttonUI));
     ...
     */
    @Override
    public WebButton setFontSizeAndStyle(final int fontSize,
    ...
    public static WebButton createIconWebButton(final ImageIcon imageIcon,
            final int round) {
        return createIconWebButton(imageIcon, round,
                FlatLafStyleConstants.shadeWidth);
    }
    
    public static WebButton createIconWebButton(final ImageIcon imageIcon,
            final int round, final int shadeWidth) {
        return createIconWebButton(imageIcon, round, shadeWidth,
                FlatLafStyleConstants.innerShadeWidth);
    }
    
    public static WebButton createIconWebButton(final ImageIcon imageIcon,
            final int round, final int shadeWidth, final int innerShadeWidth) {
        return createIconWebButton(imageIcon, round, shadeWidth,
                innerShadeWidth, FlatLafStyleConstants.rolloverDecoratedOnly);
    }
    ...
    public static WebButton createIconWebButton(final ImageIcon imageIcon,
            final int round, final boolean rolloverDecoratedOnly) {
        return createIconWebButton(imageIcon, round,
                FlatLafStyleConstants.shadeWidth,
                FlatLafStyleConstants.innerShadeWidth, rolloverDecoratedOnly,
    ...
    public static WebButton createIconWebButton(final ImageIcon imageIcon,
            ...
            final boolean rolloverDecoratedOnly) {
        return createIconWebButton(imageIcon, round, shadeWidth,
                innerShadeWidth, rolloverDecoratedOnly,
                FlatLafStyleConstants.undecorated);
    }
    
    public static WebButton createIconWebButton(final ImageIcon imageIcon,
            final int round, final int shadeWidth, final int innerShadeWidth,
            final boolean rolloverDecoratedOnly, final boolean undecorated) {
        return createIconWebButton(imageIcon, round, shadeWidth,
                innerShadeWidth, rolloverDecoratedOnly, undecorated, true);
    }
    ...
    public static WebButton createIconWebButton(final ImageIcon imageIcon,
        ...
        final WebButton iconWebButton = createWebButton(round, shadeWidth,
                innerShadeWidth, 0, rolloverDecoratedOnly, undecorated,
                drawFocus);
        iconWebButton.setIcon(imageIcon);
        return iconWebButton;
    }
    
    public static WebButton createWebButton(final int round,
            final int shadeWidth, final int innerShadeWidth,
