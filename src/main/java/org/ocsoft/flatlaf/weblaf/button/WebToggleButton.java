...
public class WebToggleButton extends JToggleButton implements ShapeProvider,
        EventMethods, ToolTipMethods, LanguageMethods, SettingsMethods,
        FontMethods<WebToggleButton>, SizeMethods<WebToggleButton> {
    ...
    public WebToggleButton(final String text, final Icon icon,
            final boolean selected, final ActionListener listener) {
        super(text, icon, selected);
        addActionListener(listener);
    }
    ...
    public WebToggleButton setBottomSelectedBgColor(
            final Color bottomSelectedBgColor) {
    ...
    public WebToggleButton setRolloverDarkBorderOnly(
    ...
    public WebToggleButton setRolloverDecoratedOnly(
    ...
    public WebToggleButton setShadeToggleIconTransparency(
    ...
    public WebToggleButton setDrawSides(final boolean top, final boolean left,
    ...
    public WebToggleButton setDrawLines(final boolean top, final boolean left,
            final boolean bottom, final boolean right) {
    ...
    public WebToggleButton setMargin(final int top, final int left,
     ...
     */
    @Override
    public WebToggleButton setFontSizeAndStyle(final int fontSize,
    ...
    public static WebToggleButton createIconWebButton(
            final ImageIcon imageIcon, final int round) {
        return createIconWebButton(imageIcon, round,
                FlatLafStyleConstants.shadeWidth);
    }
    
    public static WebToggleButton createIconWebButton(
            final ImageIcon imageIcon, final int round, final int shadeWidth) {
    ...
    public static WebToggleButton createIconWebButton(
        ...
        final WebToggleButton iconWebButton = createWebButton(round,
                shadeWidth, innerShadeWidth, 0, rolloverDecoratedOnly,
                undecorated, drawFocus);
        iconWebButton.setIcon(imageIcon);
        return iconWebButton;
    }
    
    public static WebToggleButton createWebButton(final int round,
