...
package org.ocsoft.flatlaf.weblaf.table;
...
public class WebTable extends JTable implements FontMethods<WebTable> {
    ...
    public void scrollToRow(final int row) {
        ...
        final Rectangle rect = GeometryUtils.getContainingRect(firstCell,
                lastCell);
        if (rect != null) {
    ...
    public boolean editCellAt(final int row, final int column,
        ...
        if (editingStarted) {
            ...
            try {
                final Object o = cellEditor.getClass()
                        .getMethod("getComponent").invoke(cellEditor);
    ...
    public void updateUI() {
        ...
        if (getUI() == null || !(getUI() instanceof WebTableUI)) {
            try {
                setUI((WebTableUI) ReflectUtils
                        .createInstance(FlatLafSettings.tableUI));
    ...
    private void configureEnclosingScrollPaneUI() {
        ...
        if (p instanceof JViewport) {
            ...
            if (gp instanceof JScrollPane) {
                ...
                Component corner = scrollPane
                        .getCorner(JScrollPane.UPPER_TRAILING_CORNER);
                if (corner == null || corner instanceof UIResource) {
                    corner = null;
                    final Object componentClass = UIManager
                            .get("Table.scrollPaneCornerComponent");
                    if (componentClass instanceof Class) {
                        try {
                            corner = (Component) ((Class) componentClass)
                                    .newInstance();
                        } catch (final Exception e) {
     ...
     */
    @Override
    public WebTable setFontSizeAndStyle(final int fontSize, final boolean bold,
