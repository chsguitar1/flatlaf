...
package org.ocsoft.flatlaf.weblaf.radiobutton;
...
public class WebRadioButton extends JRadioButton implements ShapeProvider,
        EventMethods, ToolTipMethods, LanguageMethods, SettingsMethods,
        FontMethods<WebRadioButton>, SizeMethods<WebRadioButton> {
    ...
    public void updateUI() {
        if (getUI() == null || !(getUI() instanceof WebRadioButtonUI)) {
            try {
                setUI((WebRadioButtonUI) ReflectUtils
                        .createInstance(FlatLafSettings.radioButtonUI));
     ...
     */
    @Override
    public WebRadioButton setFontSizeAndStyle(final int fontSize,
