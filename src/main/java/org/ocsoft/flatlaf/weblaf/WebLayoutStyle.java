...
public class WebLayoutStyle extends DefaultLayoutStyle {
    ...
    public int getPreferredGap(final JComponent component1,
        ...
        case RELATED:
            if (component1.getUIClassID().equals("ToggleButtonUI")
                    && component2.getUIClassID().equals("ToggleButtonUI")) {
    ...
    public int getContainerGap(final JComponent component, final int position,
        ...
        return getButtonGap(component, position,
    ...
    private int getButtonAdjustment(final JComponent source, final int edge) {
        ...
        if (classID.equals("ButtonUI") || classID.equals("ToggleButtonUI")) {
            ...
            if ((classID.equals("RadioButtonUI") || classID
                    .equals("CheckBoxUI"))) {
                return 1;
            }
        }
