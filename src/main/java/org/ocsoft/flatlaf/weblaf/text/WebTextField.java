...
public class WebTextField extends JTextField implements ShapeProvider,
        DocumentEventMethods, EventMethods, ToolTipMethods, LanguageMethods,
        SettingsMethods, FontMethods<WebTextField>, SizeMethods<WebTextField> {
    public WebTextField() {
        super();
    }
    ...
    public WebTextField(final Document doc, final String text,
            final int columns, final boolean drawBorder) {
        super(doc, text, columns);
        setDrawBorder(drawBorder);
    }
    ...
    public void setFieldMargin(final int top, final int left, final int bottom,
            final int right) {
    ...
    public void updateUI() {
        if (getUI() == null || !(getUI() instanceof WebTextFieldUI)) {
            try {
                setUI((WebTextFieldUI) ReflectUtils
                        .createInstance(FlatLafSettings.textFieldUI));
     ...
     */
    @Override
    public WebTextField setFontSizeAndStyle(final int fontSize,
    ...
    public static WebTextField createWebTextField(final boolean drawBorder,
            final int round) {
        return createWebTextField(drawBorder, round,
