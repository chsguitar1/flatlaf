...
public class WebFormattedTextField extends JFormattedTextField implements
        ShapeProvider, DocumentEventMethods, EventMethods, ToolTipMethods,
        LanguageMethods, SettingsMethods, FontMethods<WebFormattedTextField>,
    ...
    public void updateUI() {
        if (getUI() == null || !(getUI() instanceof WebFormattedTextFieldUI)) {
            try {
                setUI((WebFormattedTextFieldUI) ReflectUtils
                        .createInstance(FlatLafSettings.formattedTextFieldUI));
     ...
     */
    @Override
    public WebFormattedTextField setFontStyle(final boolean bold,
     ...
     */
    @Override
    public WebFormattedTextField setFontSizeAndStyle(final int fontSize,
     ...
     */
    @Override
    public WebFormattedTextField setPreferredSize(final int width,
            final int height) {
