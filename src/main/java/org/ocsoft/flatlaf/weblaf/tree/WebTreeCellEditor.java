...
public class WebTreeCellEditor<C extends JComponent> extends
        WebDefaultCellEditor<C> implements FocusListener {
    /**
     * Whether should update editor's leading icon automatically when it is
     * possible or not.
     */
    ...
    public Component getTreeCellEditorComponent(final JTree tree,
        ...
        final Component cellEditor = super.getTreeCellEditorComponent(tree,
        ...
        final Component component = tree.getCellRenderer()
        ...
        if (component instanceof JLabel
            ...
            if (cellEditor instanceof WebTextField) {
                ...
                editor.setMargin(margin.top - sm, margin.left - sm,
                        margin.bottom - sm, margin.right - sm - 2);
