 ...
 * tree nodes. Usually this object is constructed through TreeUtils
 * automatically and could be applied to some tree using these utilities aswell.
 *
 * @author Mikle Garin
 * @see TreeUtils
 */
...
public class TreeState implements Serializable, Cloneable {
     ...
     *            selection state
     */
    public void addState(final String nodeId, final boolean expanded,
    ...
    public TreeState clone() {
        return new TreeState(
                MapUtils.cloneLinkedHashMap((LinkedHashMap<String, NodeState>) states));
    }
}