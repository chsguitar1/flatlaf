...
package org.ocsoft.flatlaf.weblaf.progressbar;
...
public class WebProgressBar extends JProgressBar implements ShapeProvider,
        EventMethods, ToolTipMethods, LanguageMethods,
    ...
    public void updateUI() {
        if (getUI() == null || !(getUI() instanceof WebProgressBarUI)) {
            try {
                setUI((WebProgressBarUI) ReflectUtils
                        .createInstance(FlatLafSettings.progressBarUI));
     ...
     */
    @Override
    public WebProgressBar setFontSizeAndStyle(final int fontSize,
